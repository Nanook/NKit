...
namespace NKit.Tests.Full.Wiped
{
    ...
    {
        //Retail     / ISO       / 6.36GiB / Default ISO
        [Fact]
        public void Cebwrpg_Flycurrq_Jbeyq_Orgn_7552_59_50_chd_Scan()
        {
            string fileName = @"Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "XBox360"));
            string outFolderName = $"XBox360_Cebwrpg_Flycurrq_Jbeyq_Orgn_7552_59_50_chd_Scan_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50).chd", f.FriendlyFullPath.Replace(f.BasePath, ""));
            Assert.Equal("Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50)", f.CleanName);
            Assert.Equal("Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50)", f.Name);
            ...
            Assert.Equal("Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50).chd", f.ImageFiles[0].FileName);
            Assert.Equal("Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50)", f.ImageFiles[0].NameOnly);
            Assert.Equal(".chd", f.ImageFiles[0].Extension);
            Assert.Equal(0x254220L, f.ImageFiles[0].Size);
            ...
            Assert.Equal("Sha1:E8E726C2FE89F97A93318123EFEB9F6B704C0C4F", i.SrcParts[0].Checksums.ToString(true, true));
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Sha1:E8E726C2FE89F97A93318123EFEB9F6B704C0C4F", r.InFileParts[0].Checksums.ToString(true, true));
            Assert.Null(r.InFileParts[0].FileName);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x1972f8000L, r.OutFileParts[0].Size);
            ...
            Assert.Equal("Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50)", t.Name);
            Assert.NotNull(t.VerifyType);
            Assert.Equal("InChecksums [Sha1]", t.VerifyType);
            Assert.NotNull(t.VerifyChecksum);
            Assert.Equal("E8E726C2FE89F97A93318123EFEB9F6B704C0C4F", t.VerifyChecksum);
            ...
            Assert.Equal(Path.Combine(basePath, "Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50).nkit.yaml"), t.OutScanFilePath);
            ...
            Assert.Equal(0x1972f8000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50)", t.StepFiles[0].FileName);
            ...
            Assert.Equal("Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50)", t.Scan.Name);
            Assert.Equal(SystemType.XBox360, f.SystemType);
            Assert.Equal(0x840322e9U, t.Scan.Crc);
            Assert.Equal(0x840322e9U, t.Scan.CrcDecrypted);
            Assert.Equal(0x1972f8000L, t.Scan.Size);
            Assert.Equal(34948, t.Scan.VirtualFsTotalFileCount);
            Assert.Equal(254, t.Scan.VirtualFsTotalFoldersCount);
            ...
            Assert.Equal("1972F8000", t.Scan.Properties["Size"].ToXmlValue());
            Assert.NotNull(t.Scan.Properties["CRC"].ToXmlValue());
            Assert.Equal("840322E9", t.Scan.Properties["CRC"].ToXmlValue());
            ...
            Assert.Equal("5503F287", t.Scan.Areas[0].AreaInfo.Properties["HeaderCrc"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["HeaderXxHash"].ToXmlValue());
            Assert.Equal("DC2C3C3180B77E2", t.Scan.Areas[0].AreaInfo.Properties["HeaderXxHash"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            Assert.Equal("00032E5E7", t.Scan.Areas[0].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            ...
            Assert.Equal(0x840322e9U, t.Scan.Areas[0].Crc);
            Assert.Equal(0x840322e9U, t.Scan.Areas[0].CrcDecrypted);
            Assert.Equal(0x1972f8000L, t.Scan.Areas[0].Size);
            ...
            Assert.Equal(17471, t_ScanTypes0[FsType.Iso9660]);
            Assert.Equal(17471, t_ScanTypes0[FsType.Joliet]);
            Assert.Equal(34946, t_ScanTypes0[FsType.Udf]);
