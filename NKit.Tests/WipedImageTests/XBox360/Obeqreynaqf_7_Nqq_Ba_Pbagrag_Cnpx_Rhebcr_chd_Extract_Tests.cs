...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_XBox360_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Obeqreynaqf_7_Nqq_Ba_Pbagrag_Cnpx_Rhebcr_chd_Extract()
        {
            ...
            string outFolderName = $"XBox360_Obeqreynaqf_7_Nqq_Ba_Pbagrag_Cnpx_Rhebcr_chd_Extract_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Obeqreynaqf 7 - Nqq-Ba Pbagrag Cnpx (Rhebcr)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Obeqreynaqf 7 - Nqq-Ba Pbagrag Cnpx (Rhebcr)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Obeqreynaqf_7_Nqq_Ba_Pbagrag_Cnpx_Rhebcr_chd_Extract_Tests.txt"));
