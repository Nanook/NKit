...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_XBox360_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Qrnq_be_Nyvir_Kgerzr_7_HFN_Ra_Wn_Se_Qr_Rf_Vg_Mu_Xb_Cy_chd_ExtractForensic()
        {
            ...
            string outFolderName = $"XBox360_Qrnq_be_Nyvir_Kgerzr_7_HFN_Ra_Wn_Se_Qr_Rf_Vg_Mu_Xb_Cy_chd_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Qrnq be Nyvir Kgerzr 7 (HFN) (Ra,Wn,Se,Qr,Rf,Vg,Mu,Xb,Cy)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Qrnq be Nyvir Kgerzr 7 (HFN) (Ra,Wn,Se,Qr,Rf,Vg,Mu,Xb,Cy)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Qrnq_be_Nyvir_Kgerzr_7_HFN_Ra_Wn_Se_Qr_Rf_Vg_Mu_Xb_Cy_chd_ExtractForensic_Tests.txt"));
