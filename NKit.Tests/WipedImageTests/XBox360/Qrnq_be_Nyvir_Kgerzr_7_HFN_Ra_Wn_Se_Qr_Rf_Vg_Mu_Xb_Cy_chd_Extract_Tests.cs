...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_XBox360_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Qrnq_be_Nyvir_Kgerzr_7_HFN_Ra_Wn_Se_Qr_Rf_Vg_Mu_Xb_Cy_chd_Extract()
        {
            ...
            string outFolderName = $"XBox360_Qrnq_be_Nyvir_Kgerzr_7_HFN_Ra_Wn_Se_Qr_Rf_Vg_Mu_Xb_Cy_chd_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Qrnq_be_Nyvir_Kgerzr_7_HFN_Ra_Wn_Se_Qr_Rf_Vg_Mu_Xb_Cy_chd_Extract_Tests.txt"));
