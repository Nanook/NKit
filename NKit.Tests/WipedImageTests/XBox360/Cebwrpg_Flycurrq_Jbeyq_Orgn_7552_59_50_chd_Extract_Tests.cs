...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_XBox360_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Cebwrpg_Flycurrq_Jbeyq_Orgn_7552_59_50_chd_Extract()
        {
            ...
            string outFolderName = $"XBox360_Cebwrpg_Flycurrq_Jbeyq_Orgn_7552_59_50_chd_Extract_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Cebwrpg Flycurrq (Jbeyq) (Orgn) (7552-59-50)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Cebwrpg_Flycurrq_Jbeyq_Orgn_7552_59_50_chd_Extract_Tests.txt"));
