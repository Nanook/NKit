...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Qvfarl_Vasvavgl_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_rvz_Scan()
        {
            string fileName = @"Qvfarl Vasvavgl (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Qvfarl_Vasvavgl_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_rvz_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Qvfarl Vasvavgl (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Qvfarl Vasvavgl (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("F20BDD9B005EC92B", t.VerifyChecksum);
            ...
            Assert.Equal("Qvfarl Vasvavgl (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay)", t.StepFiles[0].FileName);
