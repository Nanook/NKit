...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Znevb_Xneg_Jvv_HFN_Ra_Se_Rf_rvz_ConvertCisoy()
        {
            string fileName = @"Znevb Xneg Jvv (HFN) (Ra,Se,Rf).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Znevb_Xneg_Jvv_HFN_Ra_Se_Rf_rvz_ConvertCisoy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Znevb Xneg Jvv (HFN) (Ra,Se,Rf).ciso", r.FinalName);
            ...
            Assert.Equal(0xb1c08240L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:D4E9A988", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Znevb Xneg Jvv (HFN) (Ra,Se,Rf).ciso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Znevb Xneg Jvv (HFN) (Ra,Se,Rf).ciso", t.OutFileName);
            ...
            Assert.Equal(0xb1c08240L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:D4E9A988", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Znevb Xneg Jvv (HFN) (Ra,Se,Rf).ciso~", t.StepFiles[0].FileName);
