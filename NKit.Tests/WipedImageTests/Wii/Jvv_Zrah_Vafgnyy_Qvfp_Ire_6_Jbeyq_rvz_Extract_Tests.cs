...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jvv_Zrah_Vafgnyy_Qvfp_Ire_6_Jbeyq_rvz_Extract()
        {
            string fileName = @"Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Jvv_Zrah_Vafgnyy_Qvfp_Ire_6_Jbeyq_rvz_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Jvv_Zrah_Vafgnyy_Qvfp_Ire_6_Jbeyq_rvz_Extract_Tests.txt"));
