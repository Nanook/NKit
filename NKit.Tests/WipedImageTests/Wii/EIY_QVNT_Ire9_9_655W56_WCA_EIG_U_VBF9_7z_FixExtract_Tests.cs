...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void EIY_QVNT_Ire9_9_655W56_WCA_EIG_U_VBF9_7z_FixExtract()
        {
            string fileName = @"EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_EIY_QVNT_Ire9_9_655W56_WCA_EIG_U_VBF9_7z_FixExtract_{Guid.NewGuid():N}";
            ...
            Assert.Equal(0x1e8000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:825C4A46", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("DCECD53A6425C869B24A7B77B0E085A653560CE2_N_825C4A46~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("DCECD53A6425C869B24A7B77B0E085A653560CE2_N_825C4A46", t.OutFileName);
            ...
            Assert.Equal(0x1e8000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:825C4A46", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("DCECD53A6425C869B24A7B77B0E085A653560CE2_N_825C4A46~", t.StepFiles[0].FileName);
