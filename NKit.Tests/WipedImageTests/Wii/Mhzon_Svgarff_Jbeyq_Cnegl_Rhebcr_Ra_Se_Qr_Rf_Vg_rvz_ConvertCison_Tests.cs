...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Mhzon_Svgarff_Jbeyq_Cnegl_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_ConvertCison()
        {
            ...
            string outFolderName = $"Wii_Mhzon_Svgarff_Jbeyq_Cnegl_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_ConvertCison_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Mhzon Svgarff - Jbeyq Cnegl (Rhebcr) (Ra,Se,Qr,Rf,Vg).ciso", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x121a08000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:B05422FF", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Mhzon Svgarff - Jbeyq Cnegl (Rhebcr) (Ra,Se,Qr,Rf,Vg).ciso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Mhzon Svgarff - Jbeyq Cnegl (Rhebcr) (Ra,Se,Qr,Rf,Vg).ciso", t.OutFileName);
            ...
            Assert.Equal(0x121a08000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:B05422FF", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Mhzon Svgarff - Jbeyq Cnegl (Rhebcr) (Ra,Se,Qr,Rf,Vg).ciso~", t.StepFiles[0].FileName);
