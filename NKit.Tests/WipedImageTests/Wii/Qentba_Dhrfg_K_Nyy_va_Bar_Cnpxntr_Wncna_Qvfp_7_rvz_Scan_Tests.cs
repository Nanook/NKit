...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Qentba_Dhrfg_K_Nyy_va_Bar_Cnpxntr_Wncna_Qvfp_7_rvz_Scan()
        {
            ...
            string outFolderName = $"Wii_Qentba_Dhrfg_K_Nyy_va_Bar_Cnpxntr_Wncna_Qvfp_7_rvz_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Qentba Dhrfg K - Nyy va Bar Cnpxntr (Wncna) (Qvfp 7).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Qentba Dhrfg K - Nyy va Bar Cnpxntr (Wncna) (Qvfp 7)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Qentba Dhrfg K - Nyy va Bar Cnpxntr (Wncna) (Qvfp 7)", t.StepFiles[0].FileName);
