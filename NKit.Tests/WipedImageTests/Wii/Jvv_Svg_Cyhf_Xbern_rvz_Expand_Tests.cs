...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jvv_Svg_Cyhf_Xbern_rvz_Expand()
        {
            string fileName = @"Jvv Svg Cyhf (Xbern).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Jvv_Svg_Cyhf_Xbern_rvz_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jvv Svg Cyhf (Xbern).iso", r.FinalName);
            ...
            Assert.Equal("Crc32:2AD2950F", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Jvv Svg Cyhf (Xbern).iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("95944C948B4332B1", t.VerifyChecksum);
            Assert.Null(t.DatMatch);
            Assert.Null(t.ErrorMsg);
            Assert.NotNull(t.OutFileName);
            Assert.Equal("Jvv Svg Cyhf (Xbern).iso", t.OutFileName);
            ...
            Assert.Equal("Crc32:2AD2950F", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Jvv Svg Cyhf (Xbern).iso~", t.StepFiles[0].FileName);
