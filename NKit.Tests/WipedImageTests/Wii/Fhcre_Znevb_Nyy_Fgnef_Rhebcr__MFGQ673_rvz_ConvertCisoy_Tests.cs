...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Fhcre_Znevb_Nyy_Fgnef_Rhebcr__MFGQ673_rvz_ConvertCisoy()
        {
            string fileName = @"Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Fhcre_Znevb_Nyy_Fgnef_Rhebcr__MFGQ673_rvz_ConvertCisoy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.ciso", r.FinalName);
            ...
            Assert.Equal(0xda08240L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:DFB3EEF8", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.ciso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.ciso", t.OutFileName);
            ...
            Assert.Equal(0xda08240L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:DFB3EEF8", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.ciso~", t.StepFiles[0].FileName);
