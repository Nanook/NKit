...
namespace NKit.Tests.Full.Wiped
{
    ...
    {
        //Unlicenced / NKit.Iso  / 1.36GiB / Hacked
        [Fact]
        public void FreeLoader_for_Nintendo_Wii_USA_Unl_nkit_iso_Scan()
        {
            string fileName = @"FreeLoader for Nintendo Wii (USA) (Unl).nkit.iso";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_FreeLoader_for_Nintendo_Wii_USA_Unl_nkit_iso_Scan_{Guid.NewGuid():N}";
            ...
            Assert.Equal("FreeLoader for Nintendo Wii (USA) (Unl).nkit.iso", f.FriendlyFullPath.Replace(f.BasePath, ""));
            Assert.Equal("FreeLoader for Nintendo Wii (USA) (Unl)", f.CleanName);
            Assert.Equal("FreeLoader for Nintendo Wii (USA) (Unl)", f.Name);
            Assert.Equal(SourceImageType.NKitIso, f.ImageType);
            ...
            Assert.Equal("FreeLoader for Nintendo Wii (USA) (Unl).nkit.iso", f.ImageFiles[0].FileName);
            Assert.Equal("FreeLoader for Nintendo Wii (USA) (Unl)", f.ImageFiles[0].NameOnly);
            Assert.Equal(".nkit.iso", f.ImageFiles[0].Extension);
            Assert.Equal(0x478000L, f.ImageFiles[0].Size);
            ...
            Assert.Equal("Crc32:1CC40417", i.SrcParts[0].Checksums.ToString(true, true));
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("FreeLoader for Nintendo Wii (USA) (Unl).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Crc32:1CC40417", r.InFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("FreeLoader for Nintendo Wii (USA) (Unl)", r.OutFileParts[0].FileName);
            Assert.NotNull(r.ResultCrc);
            Assert.Equal(0x1cc40417U, r.ResultCrc.Value);
            ...
            Assert.Equal(0x1cc40417U, t.CRC);
            Assert.Equal(0x486404f2U, t.DecryptedCrc);
            Assert.Equal(VerifyResult.VerifySuccess, t.VerifyResult);
            Assert.Equal(inPath.TrimEnd('\\', '/'), t.InFilePath.TrimEnd('\\', '/'));
            Assert.NotNull(t.OutPath);
            Assert.Equal("", t.OutPath);
            Assert.NotNull(t.Name);
            Assert.Equal("FreeLoader for Nintendo Wii (USA) (Unl)", t.Name);
            ...
            Assert.Equal(Path.Combine(basePath, "FreeLoader for Nintendo Wii (USA) (Unl).nkit.yaml"), t.OutScanFilePath);
            ...
            Assert.Equal("FreeLoader for Nintendo Wii (USA) (Unl)", t.StepFiles[0].FileName);
            ...
            Assert.Equal("FreeLoader for Nintendo Wii (USA) (Unl)", t.Scan.Name);
            Assert.Equal(SystemType.Wii, f.SystemType);
            Assert.Equal(0x1cc40417U, t.Scan.Crc);
            Assert.Equal(0x486404f2U, t.Scan.CrcDecrypted);
            ...
            Assert.Equal("1CC40417", t.Scan.Properties["CRC"].ToXmlValue());
            Assert.NotNull(t.Scan.Properties["DecryptedCRC"].ToXmlValue());
            Assert.Equal("486404F2", t.Scan.Properties["DecryptedCRC"].ToXmlValue());
            ...
            Assert.Equal(0xa3efae36U, t.Scan.Areas[0].Crc);
            Assert.Equal(0xa3efae36U, t.Scan.Areas[0].CrcDecrypted);
            ...
            Assert.Equal("4ACBAB766509C2DBADEB04B6434E461BA3262A34", t.Scan.Areas[1].AreaInfo.Properties["ContentSha"].ToXmlValue());
            ...
            Assert.Equal(0x1593109aU, t.Scan.Areas[1].Crc);
            Assert.Equal(0x1593109aU, t.Scan.Areas[1].CrcDecrypted);
            ...
            Assert.Equal(0xb139db60U, t.Scan.Areas[2].Crc);
            Assert.Equal(0x7edff9e5U, t.Scan.Areas[2].CrcDecrypted);
            ...
            Assert.Equal(0x43dab22bU, t.Scan.Areas[3].Crc);
            Assert.Equal(0x43dab22bU, t.Scan.Areas[3].CrcDecrypted);
