...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jvv_OnpxhcQvfp_565R56_rvz_ConvertRvz()
        {
            string fileName = @"Jvv OnpxhcQvfp [565R56].rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Jvv_OnpxhcQvfp_565R56_rvz_ConvertRvz_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jvv OnpxhcQvfp [565R56].rvz", r.FinalName);
            ...
            Assert.Equal(0x28e240L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:C38801C0", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Jvv OnpxhcQvfp [565R56].rvz~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Jvv OnpxhcQvfp [565R56].rvz", t.OutFileName);
            ...
            Assert.Equal(0x28e240L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:C38801C0", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Jvv OnpxhcQvfp [565R56].rvz~", t.StepFiles[0].FileName);
