...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Qentba_Dhrfg_K_Nyy_va_Bar_Cnpxntr_Wncna_Qvfp_7_rvz_ConvertCisoy()
        {
            ...
            string outFolderName = $"Wii_Qentba_Dhrfg_K_Nyy_va_Bar_Cnpxntr_Wncna_Qvfp_7_rvz_ConvertCisoy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Qentba Dhrfg K - Nyy va Bar Cnpxntr (Wncna) (Qvfp 7).ciso", r.FinalName);
            ...
            Assert.Equal(0xdb608240L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:D3EFEA95", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Qentba Dhrfg K - Nyy va Bar Cnpxntr (Wncna) (Qvfp 7).ciso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Qentba Dhrfg K - Nyy va Bar Cnpxntr (Wncna) (Qvfp 7).ciso", t.OutFileName);
            ...
            Assert.Equal(0xdb608240L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:D3EFEA95", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Qentba Dhrfg K - Nyy va Bar Cnpxntr (Wncna) (Qvfp 7).ciso~", t.StepFiles[0].FileName);
