...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void EIY_QVNT_Ire9_9_655W56_WCA_EIG_U_VBF9_7z_ConvertWbfsy()
        {
            string fileName = @"EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_EIY_QVNT_Ire9_9_655W56_WCA_EIG_U_VBF9_7z_ConvertWbfsy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).wbfs", r.FinalName);
            ...
            Assert.Equal(0x118c00000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:58E9E5FA", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).wbfs~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).wbfs", t.OutFileName);
            ...
            Assert.Equal(0x118c00000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:58E9E5FA", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).wbfs~", t.StepFiles[0].FileName);
