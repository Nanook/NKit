...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Uneirfg_Zbba_Gerr_bs_Genadhvyvgl_HFN_rvz_Scan()
        {
            string fileName = @"Uneirfg Zbba - Gerr bs Genadhvyvgl (HFN).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Uneirfg_Zbba_Gerr_bs_Genadhvyvgl_HFN_rvz_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Uneirfg Zbba - Gerr bs Genadhvyvgl (HFN).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Uneirfg Zbba - Gerr bs Genadhvyvgl (HFN)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Uneirfg Zbba - Gerr bs Genadhvyvgl (HFN)", t.StepFiles[0].FileName);
