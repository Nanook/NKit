...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Znevb_Xneg_Jvv_HFN_Ra_Se_Rf_rvz_Extract()
        {
            string fileName = @"Znevb Xneg Jvv (HFN) (Ra,Se,Rf).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Znevb_Xneg_Jvv_HFN_Ra_Se_Rf_rvz_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Znevb_Xneg_Jvv_HFN_Ra_Se_Rf_rvz_Extract_Tests.txt"));
