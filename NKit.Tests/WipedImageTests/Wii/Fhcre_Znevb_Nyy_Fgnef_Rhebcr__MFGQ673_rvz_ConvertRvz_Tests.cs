...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Fhcre_Znevb_Nyy_Fgnef_Rhebcr__MFGQ673_rvz_ConvertRvz()
        {
            string fileName = @"Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Fhcre_Znevb_Nyy_Fgnef_Rhebcr__MFGQ673_rvz_ConvertRvz_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.rvz", r.FinalName);
            ...
            Assert.Equal(0xb9a1bcL, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:E1A2FC1B", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.rvz~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.rvz", t.OutFileName);
            ...
            Assert.Equal(0xb9a1bcL, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:E1A2FC1B", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.rvz~", t.StepFiles[0].FileName);
