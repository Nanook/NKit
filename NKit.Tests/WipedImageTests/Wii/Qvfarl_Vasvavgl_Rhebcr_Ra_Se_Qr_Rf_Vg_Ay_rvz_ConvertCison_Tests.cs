...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Qvfarl_Vasvavgl_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_rvz_ConvertCison()
        {
            string fileName = @"Qvfarl Vasvavgl (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Qvfarl_Vasvavgl_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_rvz_ConvertCison_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Qvfarl Vasvavgl (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay).ciso", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x1dc608000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:EEF607D4", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Qvfarl Vasvavgl (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay).ciso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Qvfarl Vasvavgl (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay).ciso", t.OutFileName);
            ...
            Assert.Equal(0x1dc608000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:EEF607D4", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Qvfarl Vasvavgl (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay).ciso~", t.StepFiles[0].FileName);
