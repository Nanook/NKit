...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void FreeLoader_for_Nintendo_Wii_Japan_Unl_nkit_gcz_Scan()
        {
            string fileName = @"FreeLoader for Nintendo Wii (Japan) (Unl).nkit.gcz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_FreeLoader_for_Nintendo_Wii_Japan_Unl_nkit_gcz_Scan_{Guid.NewGuid():N}";
            ...
            Assert.Equal("FreeLoader for Nintendo Wii (Japan) (Unl).nkit.gcz", f.FriendlyFullPath.Replace(f.BasePath, ""));
            Assert.Equal("FreeLoader for Nintendo Wii (Japan) (Unl)", f.CleanName);
            Assert.Equal("FreeLoader for Nintendo Wii (Japan) (Unl)", f.Name);
            ...
            Assert.Equal("FreeLoader for Nintendo Wii (Japan) (Unl).nkit.gcz", f.ImageFiles[0].FileName);
            Assert.Equal("FreeLoader for Nintendo Wii (Japan) (Unl)", f.ImageFiles[0].NameOnly);
            Assert.Equal(".nkit.gcz", f.ImageFiles[0].Extension);
            Assert.Equal(0xb101L, f.ImageFiles[0].Size);
            ...
            Assert.Equal("Crc32:87152B46", i.SrcParts[0].Checksums.ToString(true, true));
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("FreeLoader for Nintendo Wii (Japan) (Unl).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Crc32:87152B46", r.InFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("FreeLoader for Nintendo Wii (Japan) (Unl)", r.OutFileParts[0].FileName);
            Assert.NotNull(r.ResultCrc);
            Assert.Equal(0x87152b46U, r.ResultCrc.Value);
            ...
            Assert.Equal(0x87152b46U, t.CRC);
            Assert.Equal(0x11a2d05eU, t.DecryptedCrc);
            Assert.Equal(VerifyResult.VerifySuccess, t.VerifyResult);
            Assert.Equal(inPath.TrimEnd('\\', '/'), t.InFilePath.TrimEnd('\\', '/'));
            Assert.NotNull(t.OutPath);
            Assert.Equal("", t.OutPath);
            Assert.NotNull(t.Name);
            Assert.Equal("FreeLoader for Nintendo Wii (Japan) (Unl)", t.Name);
            ...
            Assert.Equal(Path.Combine(basePath, "FreeLoader for Nintendo Wii (Japan) (Unl).nkit.yaml"), t.OutScanFilePath);
            ...
            Assert.Equal("FreeLoader for Nintendo Wii (Japan) (Unl)", t.StepFiles[0].FileName);
            ...
            Assert.Equal("FreeLoader for Nintendo Wii (Japan) (Unl)", t.Scan.Name);
            Assert.Equal(SystemType.Wii, f.SystemType);
            Assert.Equal(0x87152b46U, t.Scan.Crc);
            Assert.Equal(0x11a2d05eU, t.Scan.CrcDecrypted);
            ...
            Assert.Equal("87152B46", t.Scan.Properties["CRC"].ToXmlValue());
            Assert.NotNull(t.Scan.Properties["DecryptedCRC"].ToXmlValue());
            Assert.Equal("11A2D05E", t.Scan.Properties["DecryptedCRC"].ToXmlValue());
            ...
            Assert.Equal(0x58e7990fU, t.Scan.Areas[0].Crc);
            Assert.Equal(0x58e7990fU, t.Scan.Areas[0].CrcDecrypted);
            ...
            Assert.Equal("5E0CA8101D395236E849E2C99CE54BDB7CA51A02", t.Scan.Areas[1].AreaInfo.Properties["ContentSha"].ToXmlValue());
            ...
            Assert.Equal(0x3ae39d0fU, t.Scan.Areas[1].Crc);
            Assert.Equal(0x3ae39d0fU, t.Scan.Areas[1].CrcDecrypted);
            ...
            Assert.Equal(0x62d77004U, t.Scan.Areas[2].Crc);
            Assert.Equal(0xd04f4127U, t.Scan.Areas[2].CrcDecrypted);
            ...
            Assert.Equal(0x415ccf95U, t.Scan.Areas[3].Crc);
            Assert.Equal(0x415ccf95U, t.Scan.Areas[3].CrcDecrypted);
