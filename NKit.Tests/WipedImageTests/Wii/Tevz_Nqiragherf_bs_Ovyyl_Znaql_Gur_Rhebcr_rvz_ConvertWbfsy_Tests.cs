...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_ConvertWbfsy()
        {
            string fileName = @"Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_ConvertWbfsy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).wbfs", r.FinalName);
            ...
            Assert.Equal(0x37600000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:E6418355", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).wbfs~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).wbfs", t.OutFileName);
            ...
            Assert.Equal(0x37600000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:E6418355", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).wbfs~", t.StepFiles[0].FileName);
