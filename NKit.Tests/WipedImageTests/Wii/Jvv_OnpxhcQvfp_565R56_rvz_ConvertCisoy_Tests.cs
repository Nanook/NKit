...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jvv_OnpxhcQvfp_565R56_rvz_ConvertCisoy()
        {
            string fileName = @"Jvv OnpxhcQvfp [565R56].rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Jvv_OnpxhcQvfp_565R56_rvz_ConvertCisoy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jvv OnpxhcQvfp [565R56].ciso", r.FinalName);
            ...
            Assert.Equal(0x25808240L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:5EC6A915", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Jvv OnpxhcQvfp [565R56].ciso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Jvv OnpxhcQvfp [565R56].ciso", t.OutFileName);
            ...
            Assert.Equal(0x25808240L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:5EC6A915", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Jvv OnpxhcQvfp [565R56].ciso~", t.StepFiles[0].FileName);
