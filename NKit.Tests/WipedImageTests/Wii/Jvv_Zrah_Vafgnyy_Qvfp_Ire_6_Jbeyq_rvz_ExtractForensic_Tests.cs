...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jvv_Zrah_Vafgnyy_Qvfp_Ire_6_Jbeyq_rvz_ExtractForensic()
        {
            string fileName = @"Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Jvv_Zrah_Vafgnyy_Qvfp_Ire_6_Jbeyq_rvz_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Jvv_Zrah_Vafgnyy_Qvfp_Ire_6_Jbeyq_rvz_ExtractForensic_Tests.txt"));
