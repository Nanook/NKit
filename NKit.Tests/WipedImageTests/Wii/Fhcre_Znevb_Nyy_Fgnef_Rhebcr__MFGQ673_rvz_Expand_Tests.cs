...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Fhcre_Znevb_Nyy_Fgnef_Rhebcr__MFGQ673_rvz_Expand()
        {
            string fileName = @"Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Fhcre_Znevb_Nyy_Fgnef_Rhebcr__MFGQ673_rvz_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.iso", r.FinalName);
            ...
            Assert.Equal("Crc32:332435DA", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.iso", t.OutFileName);
            ...
            Assert.Equal("Crc32:332435DA", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.iso~", t.StepFiles[0].FileName);
