...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void EIY_QVNT_Ire9_9_655W56_WCA_EIG_U_VBF9_7z_Scan()
        {
            string fileName = @"EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_EIY_QVNT_Ire9_9_655W56_WCA_EIG_U_VBF9_7z_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9)", t.StepFiles[0].FileName);
