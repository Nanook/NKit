...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Qentba_Dhrfg_K_Nyy_va_Bar_Cnpxntr_Wncna_Qvfp_7_rvz_Expand()
        {
            ...
            string outFolderName = $"Wii_Qentba_Dhrfg_K_Nyy_va_Bar_Cnpxntr_Wncna_Qvfp_7_rvz_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Qentba Dhrfg K - Nyy va Bar Cnpxntr (Wncna) (Qvfp 7).iso", r.FinalName);
            ...
            Assert.Equal("Crc32:DF3D801E", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Qentba Dhrfg K - Nyy va Bar Cnpxntr (Wncna) (Qvfp 7).iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("26C009A49025113A", t.VerifyChecksum);
            Assert.Null(t.DatMatch);
            Assert.Null(t.ErrorMsg);
            Assert.NotNull(t.OutFileName);
            Assert.Equal("Qentba Dhrfg K - Nyy va Bar Cnpxntr (Wncna) (Qvfp 7).iso", t.OutFileName);
            ...
            Assert.Equal("Crc32:DF3D801E", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Qentba Dhrfg K - Nyy va Bar Cnpxntr (Wncna) (Qvfp 7).iso~", t.StepFiles[0].FileName);
