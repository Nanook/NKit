...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_ConvertRvz()
        {
            string fileName = @"Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_ConvertRvz_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).rvz", r.FinalName);
            ...
            Assert.Equal(0xdccddcL, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:D8364C0E", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).rvz~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).rvz", t.OutFileName);
            ...
            Assert.Equal(0xdccddcL, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:D8364C0E", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).rvz~", t.StepFiles[0].FileName);
