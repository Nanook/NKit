...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jvv_Svg_Cyhf_Xbern_rvz_ConvertWbfsn()
        {
            string fileName = @"Jvv Svg Cyhf (Xbern).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Jvv_Svg_Cyhf_Xbern_rvz_ConvertWbfsn_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jvv Svg Cyhf (Xbern).wbfs", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x2fc00000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:2B4C5E61", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Jvv Svg Cyhf (Xbern).wbfs~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Jvv Svg Cyhf (Xbern).wbfs", t.OutFileName);
            ...
            Assert.Equal(0x2fc00000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:2B4C5E61", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Jvv Svg Cyhf (Xbern).wbfs~", t.StepFiles[0].FileName);
