...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Fhcre_Fznfu_Oebf_Oenjy_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_Extract()
        {
            ...
            string outFolderName = $"Wii_Fhcre_Fznfu_Oebf_Oenjy_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Fhcre_Fznfu_Oebf_Oenjy_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_Extract_Tests.txt"));
