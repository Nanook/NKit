...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Znevb_Xneg_Jvv_HFN_Ra_Se_Rf_rvz_FixExtract()
        {
            string fileName = @"Znevb Xneg Jvv (HFN) (Ra,Se,Rf).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Znevb_Xneg_Jvv_HFN_Ra_Se_Rf_rvz_FixExtract_{Guid.NewGuid():N}";
            ...
            Assert.Equal(0xab68000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:6B78B055", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("830F0E5C5185E0ECA3366E2797AD964E16EACB07_N_6980D291~", r.OutFileParts[0].FileName);
            Assert.Equal(0x1d30000L, r.OutFileParts[1].Size);
            Assert.NotNull(r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.Equal("Crc32:6ACB16E8", r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[1].FileName);
            Assert.Equal("EZPR560000_01__VAF_N_87F6E4C3~", r.OutFileParts[1].FileName);
            ...
            Assert.Equal("830F0E5C5185E0ECA3366E2797AD964E16EACB07_N_6980D291|EZPR560000_01__VAF_N_87F6E4C3", t.OutFileName);
            ...
            Assert.Equal(0xab68000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:6B78B055", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("830F0E5C5185E0ECA3366E2797AD964E16EACB07_N_6980D291~", t.StepFiles[0].FileName);
            Assert.Equal(0x1d30000L, t.StepFiles[1].Size);
            ...
            Assert.Equal("Crc32:6ACB16E8", t.StepFiles[1].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[1].FileName);
            Assert.Equal("EZPR560000_01__VAF_N_87F6E4C3~", t.StepFiles[1].FileName);
