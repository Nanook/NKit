...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Fhcre_Znevb_Nyy_Fgnef_Rhebcr__MFGQ673_rvz_FixExtract()
        {
            string fileName = @"Fhcre Znevb Nyy-Fgnef (Rhebcr)_MFGQ673.rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Fhcre_Znevb_Nyy_Fgnef_Rhebcr__MFGQ673_rvz_FixExtract_{Guid.NewGuid():N}";
            ...
            Assert.Equal(0xcab8000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:E669B537", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("CE940A0265D108F00156D8BF5CC4937EADEF60C3_N_78946846~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("CE940A0265D108F00156D8BF5CC4937EADEF60C3_N_78946846", t.OutFileName);
            ...
            Assert.Equal(0xcab8000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:E669B537", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("CE940A0265D108F00156D8BF5CC4937EADEF60C3_N_78946846~", t.StepFiles[0].FileName);
