...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_Expand()
        {
            string fileName = @"Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).iso", r.FinalName);
            ...
            Assert.Equal("Crc32:AB278381", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("4F74BAB7893231B9", t.VerifyChecksum);
            Assert.Null(t.DatMatch);
            Assert.Null(t.ErrorMsg);
            Assert.NotNull(t.OutFileName);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).iso", t.OutFileName);
            ...
            Assert.Equal("Crc32:AB278381", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).iso~", t.StepFiles[0].FileName);
