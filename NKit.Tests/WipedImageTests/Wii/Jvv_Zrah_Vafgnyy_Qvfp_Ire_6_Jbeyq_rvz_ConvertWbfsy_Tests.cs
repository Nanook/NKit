...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jvv_Zrah_Vafgnyy_Qvfp_Ire_6_Jbeyq_rvz_ConvertWbfsy()
        {
            string fileName = @"Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Jvv_Zrah_Vafgnyy_Qvfp_Ire_6_Jbeyq_rvz_ConvertWbfsy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq).wbfs", r.FinalName);
            ...
            Assert.Equal(0xf400000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:83C3F243", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq).wbfs~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq).wbfs", t.OutFileName);
            ...
            Assert.Equal(0xf400000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:83C3F243", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq).wbfs~", t.StepFiles[0].FileName);
