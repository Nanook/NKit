...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Znevb_Xneg_Jvv_HFN_Ra_Se_Rf_rvz_ConvertWbfsy()
        {
            string fileName = @"Znevb Xneg Jvv (HFN) (Ra,Se,Rf).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Znevb_Xneg_Jvv_HFN_Ra_Se_Rf_rvz_ConvertWbfsy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Znevb Xneg Jvv (HFN) (Ra,Se,Rf).wbfs", r.FinalName);
            ...
            Assert.Equal(0xb1e00000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:A995972F", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Znevb Xneg Jvv (HFN) (Ra,Se,Rf).wbfs~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Znevb Xneg Jvv (HFN) (Ra,Se,Rf).wbfs", t.OutFileName);
            ...
            Assert.Equal(0xb1e00000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:A995972F", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Znevb Xneg Jvv (HFN) (Ra,Se,Rf).wbfs~", t.StepFiles[0].FileName);
