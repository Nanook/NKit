...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_Extract()
        {
            string fileName = @"Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_Extract_Tests.txt"));
