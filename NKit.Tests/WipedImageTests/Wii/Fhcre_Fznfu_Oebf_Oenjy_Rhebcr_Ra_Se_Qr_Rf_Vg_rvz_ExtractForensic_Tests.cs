...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Fhcre_Fznfu_Oebf_Oenjy_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_ExtractForensic()
        {
            ...
            string outFolderName = $"Wii_Fhcre_Fznfu_Oebf_Oenjy_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Fhcre Fznfu Oebf. Oenjy (Rhebcr) (Ra,Se,Qr,Rf,Vg)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Fhcre Fznfu Oebf. Oenjy (Rhebcr) (Ra,Se,Qr,Rf,Vg)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Fhcre_Fznfu_Oebf_Oenjy_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_ExtractForensic_Tests.txt"));
