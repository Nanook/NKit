...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Uneirfg_Zbba_Gerr_bs_Genadhvyvgl_HFN_rvz_FixExtract()
        {
            string fileName = @"Uneirfg Zbba - Gerr bs Genadhvyvgl (HFN).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Uneirfg_Zbba_Gerr_bs_Genadhvyvgl_HFN_rvz_FixExtract_{Guid.NewGuid():N}";
            ...
            Assert.Equal("830F0E5C5185E0ECA3366E2797AD964E16EACB07_N_6980D291", t.OutFileName);
