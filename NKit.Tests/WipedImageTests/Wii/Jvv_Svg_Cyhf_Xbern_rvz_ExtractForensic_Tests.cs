...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jvv_Svg_Cyhf_Xbern_rvz_ExtractForensic()
        {
            string fileName = @"Jvv Svg Cyhf (Xbern).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Jvv_Svg_Cyhf_Xbern_rvz_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jvv Svg Cyhf (Xbern)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Jvv Svg Cyhf (Xbern)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Jvv_Svg_Cyhf_Xbern_rvz_ExtractForensic_Tests.txt"));
