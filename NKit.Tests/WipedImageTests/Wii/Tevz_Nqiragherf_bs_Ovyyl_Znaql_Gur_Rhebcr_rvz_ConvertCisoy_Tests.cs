...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_ConvertCisoy()
        {
            string fileName = @"Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_ConvertCisoy_{Guid.NewGuid():N}";
            ...
            SystemPresetSettings presets = base.CreatePresets("Convert", @"ciso:y", inPath, fileName, outFolderName, dats, keys, fixInfo, fixFiles);
            ...
            Assert.Equal("ciso[nkit]", i.ImageConfig);
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).ciso", r.FinalName);
            ...
            Assert.Equal("Crc32:AB278381, Md5:C1C200DAC23795EE729FD4A4CCCBDBE2, Sha1:1C4A689700FF8A46E070462BA02B4F3CCCBC9B18, XxHash:4F74BAB7893231B9", r.InFileParts[0].Checksums.ToString(true, true));
            Assert.Null(r.InFileParts[0].FileName);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x37408240L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:AD9CEDFD", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).ciso~", r.OutFileParts[0].FileName);
            Assert.NotNull(r.ResultCrc);
            Assert.Equal(0xab278381U, r.ResultCrc.Value);
            ...
            Assert.Equal(0xab278381U, t.CRC);
            Assert.Equal(0xd21c0de6U, t.DecryptedCrc);
            ...
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).ciso", t.OutFileName);
            Assert.Null(t.OutKeyFilePath);
            Assert.NotNull(t.OutScanFilePath);
            Assert.Equal(Path.Combine(basePath, "Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).nkit.yaml"), t.OutScanFilePath);
            ...
            Assert.Equal(0x37408240L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:AD9CEDFD", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).ciso~", t.StepFiles[0].FileName);
            ...
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr)", t.Scan.Name);
            Assert.Equal(SystemType.Wii, f.SystemType);
            Assert.Equal(0xab278381U, t.Scan.Crc);
            Assert.Equal(0xd21c0de6U, t.Scan.CrcDecrypted);
            Assert.Equal(0x118240000L, t.Scan.Size);
            Assert.Equal(3420, t.Scan.VirtualFsTotalFileCount);
            Assert.Equal(412, t.Scan.VirtualFsTotalFoldersCount);
            ...
            Assert.Equal("AB278381", t.Scan.Properties["CRC"].ToXmlValue());
            Assert.NotNull(t.Scan.Properties["DecryptedCRC"].ToXmlValue());
            Assert.Equal("D21C0DE6", t.Scan.Properties["DecryptedCRC"].ToXmlValue());
            Assert.Equal(7, t.Scan.Areas.Count);
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["ID"].ToXmlValue());
            Assert.Equal("ETZC0Q", t.Scan.Areas[0].AreaInfo.Properties["ID"].ToXmlValue());
            ...
            Assert.Equal("Gur Tevz Nqiragherf bs Ovyyl naq Znaql", t.Scan.Areas[0].AreaInfo.Properties["Title"].ToXmlValue());
            ...
            Assert.Equal(0xd4dedf99U, t.Scan.Areas[0].Crc);
            Assert.Equal(0xd4dedf99U, t.Scan.Areas[0].CrcDecrypted);
            ...
            Assert.Equal("53290F824EA4A90C9D4888AE9B9C02A5CDC693C5", t.Scan.Areas[1].AreaInfo.Properties["ContentSha"].ToXmlValue());
            ...
            Assert.Equal(0x2b293a03U, t.Scan.Areas[1].Crc);
            Assert.Equal(0x2b293a03U, t.Scan.Areas[1].CrcDecrypted);
            ...
            Assert.Equal("C048B2E3", t.Scan.Areas[2].AreaInfo.Properties["SystemDataCrc"].ToXmlValue());
            ...
            Assert.Equal("000035170", t.Scan.Areas[2].AreaInfo.Properties["JunkLeadingNulls"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[2].AreaInfo.Properties["JunkEndNullsOffset"].ToXmlValue());
            Assert.Equal("0001E0000", t.Scan.Areas[2].AreaInfo.Properties["JunkEndNullsOffset"].ToXmlValue());
            Assert.Equal(AreaType.FileSystem, t.Scan.Areas[2].Type);
            Assert.Equal(0xdf10f7ffU, t.Scan.Areas[2].Crc);
            Assert.Equal(0x6af00ca6U, t.Scan.Areas[2].CrcDecrypted);
            Assert.Equal(0x1f0000L, t.Scan.Areas[2].Size);
            ...
            Assert.Equal(0xc1ac36e5U, t.Scan.Areas[3].Crc);
            Assert.Equal(0xc1ac36e5U, t.Scan.Areas[3].CrcDecrypted);
            Assert.Equal(0xf5a0000L, t.Scan.Areas[3].Size);
            ...
            Assert.Equal("AA5AB921481B51A0D9AD0358A80CC64468EAFBED", t.Scan.Areas[4].AreaInfo.Properties["ContentSha"].ToXmlValue());
            ...
            Assert.Equal(0x1765ef06U, t.Scan.Areas[4].Crc);
            Assert.Equal(0x1765ef06U, t.Scan.Areas[4].CrcDecrypted);
            ...
            Assert.Equal("ETZC0Q", t.Scan.Areas[5].AreaInfo.Properties["ID"].ToXmlValue());
            ...
            Assert.Equal("Gur Tevz Nqiragherf bs Ovyyl naq Znaql", t.Scan.Areas[5].AreaInfo.Properties["Title"].ToXmlValue());
            ...
            Assert.Equal("71FAABCA", t.Scan.Areas[5].AreaInfo.Properties["SystemDataCrc"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[5].AreaInfo.Properties["JunkID"].ToXmlValue());
            Assert.Equal("ETZC", t.Scan.Areas[5].AreaInfo.Properties["JunkID"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[5].AreaInfo.Properties["JunkLeadingNulls"].ToXmlValue());
            Assert.Equal("00049E5AC", t.Scan.Areas[5].AreaInfo.Properties["JunkLeadingNulls"].ToXmlValue());
            ...
            Assert.Equal(0xb3a21953U, t.Scan.Areas[5].Crc);
            Assert.Equal(0xa8b049c3U, t.Scan.Areas[5].CrcDecrypted);
            ...
            Assert.Equal("ETZC", t.Scan.Areas[6].AreaInfo.Properties["JunkID"].ToXmlValue());
            Assert.Equal(AreaType.Other, t.Scan.Areas[6].Type);
            Assert.Equal(0xc15ce6c8U, t.Scan.Areas[6].Crc);
            Assert.Equal(0xc15ce6c8U, t.Scan.Areas[6].CrcDecrypted);
