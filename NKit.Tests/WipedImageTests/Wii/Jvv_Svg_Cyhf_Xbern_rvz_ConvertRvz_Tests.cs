...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jvv_Svg_Cyhf_Xbern_rvz_ConvertRvz()
        {
            string fileName = @"Jvv Svg Cyhf (Xbern).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Jvv_Svg_Cyhf_Xbern_rvz_ConvertRvz_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jvv Svg Cyhf (Xbern).rvz", r.FinalName);
            ...
            Assert.Equal("Crc32:2AD2950F, Md5:E415A0C0E577BD892B020545C5C20079, Sha1:35233958F9D5A0E82E347056333F1A108A51BCA7, XxHash:95944C948B4332B1", r.InFileParts[0].Checksums.ToString(true, true));
            Assert.Null(r.InFileParts[0].FileName);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x9e4fb8L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:C4FF8025", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Jvv Svg Cyhf (Xbern).rvz~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Jvv Svg Cyhf (Xbern).rvz", t.OutFileName);
            ...
            Assert.Equal(0x9e4fb8L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:C4FF8025", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Jvv Svg Cyhf (Xbern).rvz~", t.StepFiles[0].FileName);
