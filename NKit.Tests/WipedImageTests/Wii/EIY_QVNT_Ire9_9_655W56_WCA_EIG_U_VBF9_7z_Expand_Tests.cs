...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void EIY_QVNT_Ire9_9_655W56_WCA_EIG_U_VBF9_7z_Expand()
        {
            string fileName = @"EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_EIY_QVNT_Ire9_9_655W56_WCA_EIG_U_VBF9_7z_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).iso", r.FinalName);
            ...
            Assert.Equal("Crc32:78020AFD", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).iso", t.OutFileName);
            ...
            Assert.Equal("Crc32:78020AFD", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).iso~", t.StepFiles[0].FileName);
