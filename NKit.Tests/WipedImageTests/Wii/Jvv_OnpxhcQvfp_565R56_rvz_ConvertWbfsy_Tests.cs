...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jvv_OnpxhcQvfp_565R56_rvz_ConvertWbfsy()
        {
            string fileName = @"Jvv OnpxhcQvfp [565R56].rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Jvv_OnpxhcQvfp_565R56_rvz_ConvertWbfsy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jvv OnpxhcQvfp [565R56].wbfs", r.FinalName);
            ...
            Assert.Equal(0x25a00000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:67845F83", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Jvv OnpxhcQvfp [565R56].wbfs~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Jvv OnpxhcQvfp [565R56].wbfs", t.OutFileName);
            ...
            Assert.Equal(0x25a00000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:67845F83", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Jvv OnpxhcQvfp [565R56].wbfs~", t.StepFiles[0].FileName);
