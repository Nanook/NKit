...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Mhzon_Svgarff_Jbeyq_Cnegl_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_ConvertRvz()
        {
            ...
            string outFolderName = $"Wii_Mhzon_Svgarff_Jbeyq_Cnegl_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_ConvertRvz_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Mhzon Svgarff - Jbeyq Cnegl (Rhebcr) (Ra,Se,Qr,Rf,Vg).rvz", r.FinalName);
            ...
            Assert.Equal(0x9d0b30L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:D699AF24", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Mhzon Svgarff - Jbeyq Cnegl (Rhebcr) (Ra,Se,Qr,Rf,Vg).rvz~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Mhzon Svgarff - Jbeyq Cnegl (Rhebcr) (Ra,Se,Qr,Rf,Vg).rvz", t.OutFileName);
            ...
            Assert.Equal(0x9d0b30L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:D699AF24", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Mhzon Svgarff - Jbeyq Cnegl (Rhebcr) (Ra,Se,Qr,Rf,Vg).rvz~", t.StepFiles[0].FileName);
