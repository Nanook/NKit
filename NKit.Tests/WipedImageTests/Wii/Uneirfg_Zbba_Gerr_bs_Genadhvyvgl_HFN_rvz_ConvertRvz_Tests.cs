...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Uneirfg_Zbba_Gerr_bs_Genadhvyvgl_HFN_rvz_ConvertRvz()
        {
            string fileName = @"Uneirfg Zbba - Gerr bs Genadhvyvgl (HFN).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Uneirfg_Zbba_Gerr_bs_Genadhvyvgl_HFN_rvz_ConvertRvz_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Uneirfg Zbba - Gerr bs Genadhvyvgl (HFN).rvz", r.FinalName);
            ...
            Assert.Equal("Crc32:DD35F2E6, Md5:949EE12CCE1A589794BADBEF233DF894, Sha1:9F1A926820617BB04223AF6E192FC9654B40D5DF, XxHash:BCE2569E6B8001B6", r.InFileParts[0].Checksums.ToString(true, true));
            Assert.Null(r.InFileParts[0].FileName);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x853908L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:9227F3AB", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Uneirfg Zbba - Gerr bs Genadhvyvgl (HFN).rvz~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Uneirfg Zbba - Gerr bs Genadhvyvgl (HFN).rvz", t.OutFileName);
            ...
            Assert.Equal(0x853908L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:9227F3AB", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Uneirfg Zbba - Gerr bs Genadhvyvgl (HFN).rvz~", t.StepFiles[0].FileName);
