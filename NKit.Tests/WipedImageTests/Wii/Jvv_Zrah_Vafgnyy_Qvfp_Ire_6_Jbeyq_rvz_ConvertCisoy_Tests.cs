...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jvv_Zrah_Vafgnyy_Qvfp_Ire_6_Jbeyq_rvz_ConvertCisoy()
        {
            string fileName = @"Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Jvv_Zrah_Vafgnyy_Qvfp_Ire_6_Jbeyq_rvz_ConvertCisoy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq).ciso", r.FinalName);
            ...
            Assert.Equal(0xf208240L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:5ECAD022", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq).ciso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq).ciso", t.OutFileName);
            ...
            Assert.Equal(0xf208240L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:5ECAD022", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Jvv Zrah Vafgnyy Qvfp (Ire. 6) (Jbeyq).ciso~", t.StepFiles[0].FileName);
