...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_FixExtract()
        {
            string fileName = @"Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_FixExtract_{Guid.NewGuid():N}";
            ...
            Assert.Equal(0x688000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:E84D6E19", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("53290F824EA4A90C9D4888AE9B9C02A5CDC693C5_N_A393D814~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("53290F824EA4A90C9D4888AE9B9C02A5CDC693C5_N_A393D814", t.OutFileName);
            ...
            Assert.Equal(0x688000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:E84D6E19", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("53290F824EA4A90C9D4888AE9B9C02A5CDC693C5_N_A393D814~", t.StepFiles[0].FileName);
