...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Mhzon_Svgarff_Jbeyq_Cnegl_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_ExtractForensic()
        {
            ...
            string outFolderName = $"Wii_Mhzon_Svgarff_Jbeyq_Cnegl_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Mhzon Svgarff - Jbeyq Cnegl (Rhebcr) (Ra,Se,Qr,Rf,Vg)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Mhzon Svgarff - Jbeyq Cnegl (Rhebcr) (Ra,Se,Qr,Rf,Vg)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Mhzon_Svgarff_Jbeyq_Cnegl_Rhebcr_Ra_Se_Qr_Rf_Vg_rvz_ExtractForensic_Tests.txt"));
