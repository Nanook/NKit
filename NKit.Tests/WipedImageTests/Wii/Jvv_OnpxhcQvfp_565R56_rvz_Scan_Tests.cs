...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jvv_OnpxhcQvfp_565R56_rvz_Scan()
        {
            string fileName = @"Jvv OnpxhcQvfp [565R56].rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Jvv_OnpxhcQvfp_565R56_rvz_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jvv OnpxhcQvfp [565R56].nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Jvv OnpxhcQvfp [565R56]", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Jvv OnpxhcQvfp [565R56]", t.StepFiles[0].FileName);
