...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_Scan()
        {
            string fileName = @"Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_Tevz_Nqiragherf_bs_Ovyyl_Znaql_Gur_Rhebcr_rvz_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Tevz Nqiragherf bs Ovyyl & Znaql, Gur (Rhebcr)", t.StepFiles[0].FileName);
