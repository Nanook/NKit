...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void EIY_QVNT_Ire9_9_655W56_WCA_EIG_U_VBF9_7z_ConvertCisoy()
        {
            string fileName = @"EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Wii"));
            string outFolderName = $"Wii_EIY_QVNT_Ire9_9_655W56_WCA_EIG_U_VBF9_7z_ConvertCisoy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).ciso", r.FinalName);
            ...
            Assert.Equal(0x118a08240L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:B270C3FC", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).ciso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).ciso", t.OutFileName);
            ...
            Assert.Equal(0x118a08240L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:B270C3FC", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("EIY_QVNT_Ire9_9 (655W56) (WCA) EIG-U (VBF9).ciso~", t.StepFiles[0].FileName);
