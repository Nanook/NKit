...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Wii_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Qentba_Dhrfg_K_Nyy_va_Bar_Cnpxntr_Wncna_Qvfp_7_rvz_FixExtract()
        {
            ...
            string outFolderName = $"Wii_Qentba_Dhrfg_K_Nyy_va_Bar_Cnpxntr_Wncna_Qvfp_7_rvz_FixExtract_{Guid.NewGuid():N}";
            ...
            Assert.Equal(0xb5c0000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:503FE1D4", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("6E61C0C6426BE91AD47EEA3DB391FA75D59B3EF6_N_F6B20CA8~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("6E61C0C6426BE91AD47EEA3DB391FA75D59B3EF6_N_F6B20CA8", t.OutFileName);
            ...
            Assert.Equal(0xb5c0000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:503FE1D4", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("6E61C0C6426BE91AD47EEA3DB391FA75D59B3EF6_N_F6B20CA8~", t.StepFiles[0].FileName);
