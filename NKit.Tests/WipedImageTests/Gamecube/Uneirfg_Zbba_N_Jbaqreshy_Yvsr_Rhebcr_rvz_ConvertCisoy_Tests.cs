...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Uneirfg_Zbba_N_Jbaqreshy_Yvsr_Rhebcr_rvz_ConvertCisoy()
        {
            string fileName = @"Uneirfg Zbba - N Jbaqreshy Yvsr (Rhebcr).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Gamecube"));
            string outFolderName = $"Gamecube_Uneirfg_Zbba_N_Jbaqreshy_Yvsr_Rhebcr_rvz_ConvertCisoy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Uneirfg Zbba - N Jbaqreshy Yvsr (Rhebcr).ciso", r.FinalName);
            ...
            Assert.Equal(0x1f808240L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:31B8E894", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Uneirfg Zbba - N Jbaqreshy Yvsr (Rhebcr).ciso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Uneirfg Zbba - N Jbaqreshy Yvsr (Rhebcr).ciso", t.OutFileName);
            ...
            Assert.Equal(0x1f808240L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:31B8E894", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Uneirfg Zbba - N Jbaqreshy Yvsr (Rhebcr).ciso~", t.StepFiles[0].FileName);
