...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void FreeLoader_for_GameCube_Europe_Unl_v1_04_rvz_ExtractForensic()
        {
            ...
            string outFolderName = $"Gamecube_FreeLoader_for_GameCube_Europe_Unl_v1_04_rvz_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "FreeLoader for GameCube (Europe) (Unl) (v1.04)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "FreeLoader_for_GameCube_Europe_Unl_v1_04_rvz_ExtractForensic_Tests.txt"));
