...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void FreeLoader_for_GameCube_Europe_Unl_v1_04_rvz_Expand()
        {
            ...
            string outFolderName = $"Gamecube_FreeLoader_for_GameCube_Europe_Unl_v1_04_rvz_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04).iso", r.FinalName);
            ...
            Assert.Equal("Crc32:22EAE5C0", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04).iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04).iso", t.OutFileName);
            ...
            Assert.Equal("Crc32:22EAE5C0", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04).iso~", t.StepFiles[0].FileName);
