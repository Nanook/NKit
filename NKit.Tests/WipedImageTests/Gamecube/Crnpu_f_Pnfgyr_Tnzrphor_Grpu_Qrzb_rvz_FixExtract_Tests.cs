...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Crnpu_f_Pnfgyr_Tnzrphor_Grpu_Qrzb_rvz_FixExtract()
        {
            string fileName = @"Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Gamecube"));
            string outFolderName = $"Gamecube_Crnpu_f_Pnfgyr_Tnzrphor_Grpu_Qrzb_rvz_FixExtract_{Guid.NewGuid():N}";
            ...
            Assert.Equal(0x1f2fL, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:36FE2FB1", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("fst[55 R560000][7FD879DC][916A0F0E][C5FB49F4].bin~", r.OutFileParts[0].FileName);
            Assert.Equal(0x1b4e4L, r.OutFileParts[1].Size);
            Assert.NotNull(r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.Equal("Crc32:7FD879DC", r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[1].FileName);
            Assert.Equal("appldr[20020905][7FD879DC].bin~", r.OutFileParts[1].FileName);
            ...
            Assert.Equal("fst[55 R560000][7FD879DC][916A0F0E][C5FB49F4].bin|appldr[20020905][7FD879DC].bin", t.OutFileName);
            ...
            Assert.Equal(0x1f2fL, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:36FE2FB1", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("fst[55 R560000][7FD879DC][916A0F0E][C5FB49F4].bin~", t.StepFiles[0].FileName);
            ...
            Assert.Equal("Crc32:7FD879DC", t.StepFiles[1].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[1].FileName);
            Assert.Equal("appldr[20020905][7FD879DC].bin~", t.StepFiles[1].FileName);
