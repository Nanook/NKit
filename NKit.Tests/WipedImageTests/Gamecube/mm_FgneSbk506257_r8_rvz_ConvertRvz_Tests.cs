...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void mm_FgneSbk506257_r8_rvz_ConvertRvz()
        {
            string fileName = @"mm_FgneSbk506257_r8.rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Gamecube"));
            string outFolderName = $"Gamecube_mm_FgneSbk506257_r8_rvz_ConvertRvz_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("mm_FgneSbk506257_r8.rvz", r.FinalName);
            ...
            Assert.Equal(0x1728ccL, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:8954D466", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("mm_FgneSbk506257_r8.rvz~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("mm_FgneSbk506257_r8.rvz", t.OutFileName);
            ...
            Assert.Equal(0x1728ccL, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:8954D466", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("mm_FgneSbk506257_r8.rvz~", t.StepFiles[0].FileName);
