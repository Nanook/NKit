...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Crnpu_f_Pnfgyr_Tnzrphor_Grpu_Qrzb_rvz_ConvertCisoy()
        {
            string fileName = @"Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Gamecube"));
            string outFolderName = $"Gamecube_Crnpu_f_Pnfgyr_Tnzrphor_Grpu_Qrzb_rvz_ConvertCisoy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.ciso", r.FinalName);
            ...
            Assert.Equal(0x2008240L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:1897BA75", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.ciso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.ciso", t.OutFileName);
            ...
            Assert.Equal(0x2008240L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:1897BA75", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.ciso~", t.StepFiles[0].FileName);
