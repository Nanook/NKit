...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Crnpu_f_Pnfgyr_Tnzrphor_Grpu_Qrzb_rvz_Scan()
        {
            string fileName = @"Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Gamecube"));
            string outFolderName = $"Gamecube_Crnpu_f_Pnfgyr_Tnzrphor_Grpu_Qrzb_rvz_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb", t.StepFiles[0].FileName);
