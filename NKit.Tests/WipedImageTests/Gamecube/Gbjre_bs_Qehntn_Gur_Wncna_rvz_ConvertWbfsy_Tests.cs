...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Gbjre_bs_Qehntn_Gur_Wncna_rvz_ConvertWbfsy()
        {
            string fileName = @"Gbjre bs Qehntn, Gur (Wncna).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Gamecube"));
            string outFolderName = $"Gamecube_Gbjre_bs_Qehntn_Gur_Wncna_rvz_ConvertWbfsy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Gbjre bs Qehntn, Gur (Wncna).wbfs", r.FinalName);
            ...
            Assert.Equal(0x600000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:73106B00", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Gbjre bs Qehntn, Gur (Wncna).wbfs~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Gbjre bs Qehntn, Gur (Wncna).wbfs", t.OutFileName);
            ...
            Assert.Equal(0x600000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:73106B00", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Gbjre bs Qehntn, Gur (Wncna).wbfs~", t.StepFiles[0].FileName);
