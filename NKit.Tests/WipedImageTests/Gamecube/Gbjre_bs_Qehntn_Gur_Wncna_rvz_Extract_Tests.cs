...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Gbjre_bs_Qehntn_Gur_Wncna_rvz_Extract()
        {
            string fileName = @"Gbjre bs Qehntn, Gur (Wncna).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Gamecube"));
            string outFolderName = $"Gamecube_Gbjre_bs_Qehntn_Gur_Wncna_rvz_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Gbjre_bs_Qehntn_Gur_Wncna_rvz_Extract_Tests.txt"));
