...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void FreeLoader_for_GameCube_Europe_Unl_v1_04_rvz_ConvertRvz()
        {
            ...
            string outFolderName = $"Gamecube_FreeLoader_for_GameCube_Europe_Unl_v1_04_rvz_ConvertRvz_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04).rvz", r.FinalName);
            ...
            Assert.Equal(0x5c4bcL, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:B1831807", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04).rvz~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04).rvz", t.OutFileName);
            ...
            Assert.Equal(0x5c4bcL, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:B1831807", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04).rvz~", t.StepFiles[0].FileName);
