...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Gbjre_bs_Qehntn_Gur_Wncna_rvz_ConvertCisoy()
        {
            string fileName = @"Gbjre bs Qehntn, Gur (Wncna).rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Gamecube"));
            string outFolderName = $"Gamecube_Gbjre_bs_Qehntn_Gur_Wncna_rvz_ConvertCisoy_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Gbjre bs Qehntn, Gur (Wncna).ciso", r.FinalName);
            ...
            Assert.Equal(0x408240L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:B519625A", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Gbjre bs Qehntn, Gur (Wncna).ciso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Gbjre bs Qehntn, Gur (Wncna).ciso", t.OutFileName);
            ...
            Assert.Equal(0x408240L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:B519625A", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Gbjre bs Qehntn, Gur (Wncna).ciso~", t.StepFiles[0].FileName);
