...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void mm_FgneSbk506257_r8_rvz_Scan()
        {
            string fileName = @"mm_FgneSbk506257_r8.rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Gamecube"));
            string outFolderName = $"Gamecube_mm_FgneSbk506257_r8_rvz_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("mm_FgneSbk506257_r8.nkit.yaml", r.FinalName);
            ...
            Assert.Equal("mm_FgneSbk506257_r8", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("mm_FgneSbk506257_r8", t.StepFiles[0].FileName);
