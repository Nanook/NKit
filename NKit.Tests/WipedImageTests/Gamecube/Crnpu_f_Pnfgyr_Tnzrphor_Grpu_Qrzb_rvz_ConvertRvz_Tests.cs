...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Crnpu_f_Pnfgyr_Tnzrphor_Grpu_Qrzb_rvz_ConvertRvz()
        {
            string fileName = @"Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Gamecube"));
            string outFolderName = $"Gamecube_Crnpu_f_Pnfgyr_Tnzrphor_Grpu_Qrzb_rvz_ConvertRvz_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.rvz", r.FinalName);
            ...
            Assert.Equal(0x21a84L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:154416FB", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.rvz~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.rvz", t.OutFileName);
            ...
            Assert.Equal(0x21a84L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:154416FB", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.rvz~", t.StepFiles[0].FileName);
