...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void FreeLoader_for_GameCube_Europe_Unl_v1_04_rvz_ConvertWbfsn()
        {
            ...
            string outFolderName = $"Gamecube_FreeLoader_for_GameCube_Europe_Unl_v1_04_rvz_ConvertWbfsn_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04).wbfs", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x400000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:54C60828", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04).wbfs~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04).wbfs", t.OutFileName);
            ...
            Assert.Equal(0x400000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:54C60828", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("FreeLoader for GameCube (Europe) (Unl) (v1.04).wbfs~", t.StepFiles[0].FileName);
