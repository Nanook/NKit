...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Crnpu_f_Pnfgyr_Tnzrphor_Grpu_Qrzb_rvz_Extract()
        {
            string fileName = @"Crnpu'f_Pnfgyr_Tnzrphor_Grpu_Qrzb.rvz";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Gamecube"));
            string outFolderName = $"Gamecube_Crnpu_f_Pnfgyr_Tnzrphor_Grpu_Qrzb_rvz_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Crnpu_f_Pnfgyr_Tnzrphor_Grpu_Qrzb_rvz_Extract_Tests.txt"));
