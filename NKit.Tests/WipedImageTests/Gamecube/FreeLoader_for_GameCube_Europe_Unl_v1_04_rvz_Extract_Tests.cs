...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void FreeLoader_for_GameCube_Europe_Unl_v1_04_rvz_Extract()
        {
            ...
            string outFolderName = $"Gamecube_FreeLoader_for_GameCube_Europe_Unl_v1_04_rvz_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "FreeLoader_for_GameCube_Europe_Unl_v1_04_rvz_Extract_Tests.txt"));
