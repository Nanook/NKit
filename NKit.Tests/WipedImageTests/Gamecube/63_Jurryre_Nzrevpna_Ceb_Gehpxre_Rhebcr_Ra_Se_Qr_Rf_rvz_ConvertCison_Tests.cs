...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Gamecube_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void _63_Jurryre_Nzrevpna_Ceb_Gehpxre_Rhebcr_Ra_Se_Qr_Rf_rvz_ConvertCison()
        {
            ...
            string outFolderName = $"Gamecube__63_Jurryre_Nzrevpna_Ceb_Gehpxre_Rhebcr_Ra_Se_Qr_Rf_rvz_ConvertCison_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("63 Jurryre - Nzrevpna Ceb Gehpxre (Rhebcr) (Ra,Se,Qr,Rf).ciso", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x11008000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:73581F7D", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("63 Jurryre - Nzrevpna Ceb Gehpxre (Rhebcr) (Ra,Se,Qr,Rf).ciso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("63 Jurryre - Nzrevpna Ceb Gehpxre (Rhebcr) (Ra,Se,Qr,Rf).ciso", t.OutFileName);
            ...
            Assert.Equal(0x11008000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:73581F7D", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("63 Jurryre - Nzrevpna Ceb Gehpxre (Rhebcr) (Ra,Se,Qr,Rf).ciso~", t.StepFiles[0].FileName);
