...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Psp_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void _552_Sebz_Ehffvn_jvgu_Ybir_HX_Ra_Se_Qr_Rf_Vg_jso_ConvertZso()
        {
            ...
            string outFolderName = $"Psp__552_Sebz_Ehffvn_jvgu_Ybir_HX_Ra_Se_Qr_Rf_Vg_jso_ConvertZso_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("552 - Sebz Ehffvn jvgu Ybir (HX) (Ra,Se,Qr,Rf,Vg).zso", r.FinalName);
            ...
            Assert.Equal(0x99a2b8L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:C27F720F", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("552 - Sebz Ehffvn jvgu Ybir (HX) (Ra,Se,Qr,Rf,Vg).zso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("552 - Sebz Ehffvn jvgu Ybir (HX) (Ra,Se,Qr,Rf,Vg).zso", t.OutFileName);
            ...
            Assert.Equal(0x99a2b8L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:C27F720F", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("552 - Sebz Ehffvn jvgu Ybir (HX) (Ra,Se,Qr,Rf,Vg).zso~", t.StepFiles[0].FileName);
