...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Psp_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void _552_Sebz_Ehffvn_jvgu_Ybir_HX_Ra_Se_Qr_Rf_Vg_dax_ConvertCso()
        {
            ...
            string outFolderName = $"Psp__552_Sebz_Ehffvn_jvgu_Ybir_HX_Ra_Se_Qr_Rf_Vg_dax_ConvertCso_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Crc32:892EA66C", r.OutFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:892EA66C", t.StepFiles[0].Checksums.ToString(true, true));
