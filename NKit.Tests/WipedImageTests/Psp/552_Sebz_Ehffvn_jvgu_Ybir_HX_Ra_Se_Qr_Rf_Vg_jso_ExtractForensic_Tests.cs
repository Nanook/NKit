...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Psp_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void _552_Sebz_Ehffvn_jvgu_Ybir_HX_Ra_Se_Qr_Rf_Vg_jso_ExtractForensic()
        {
            ...
            string outFolderName = $"Psp__552_Sebz_Ehffvn_jvgu_Ybir_HX_Ra_Se_Qr_Rf_Vg_jso_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("552 - Sebz Ehffvn jvgu Ybir (HX) (Ra,Se,Qr,Rf,Vg)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "552 - Sebz Ehffvn jvgu Ybir (HX) (Ra,Se,Qr,Rf,Vg)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "552_Sebz_Ehffvn_jvgu_Ybir_HX_Ra_Se_Qr_Rf_Vg_jso_ExtractForensic_Tests.txt"));
