...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Psp_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void _552_Sebz_Ehffvn_jvgu_Ybir_HX_Ra_Se_Qr_Rf_Vg_jso_Scan()
        {
            ...
            string outFolderName = $"Psp__552_Sebz_Ehffvn_jvgu_Ybir_HX_Ra_Se_Qr_Rf_Vg_jso_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("552 - Sebz Ehffvn jvgu Ybir (HX) (Ra,Se,Qr,Rf,Vg).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("552 - Sebz Ehffvn jvgu Ybir (HX) (Ra,Se,Qr,Rf,Vg)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("552 - Sebz Ehffvn jvgu Ybir (HX) (Ra,Se,Qr,Rf,Vg)", t.StepFiles[0].FileName);
