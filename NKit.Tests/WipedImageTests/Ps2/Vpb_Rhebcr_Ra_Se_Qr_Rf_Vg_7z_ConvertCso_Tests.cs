...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps2_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Vpb_Rhebcr_Ra_Se_Qr_Rf_Vg_7z_ConvertCso()
        {
            string fileName = @"Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Vpb_Rhebcr_Ra_Se_Qr_Rf_Vg_7z_ConvertCso_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Crc32:D07D09D9", r.OutFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:D07D09D9", t.StepFiles[0].Checksums.ToString(true, true));
