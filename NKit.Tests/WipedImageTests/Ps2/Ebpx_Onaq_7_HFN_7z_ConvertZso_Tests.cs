...
namespace NKit.Tests.Full.Wiped
{
    ...
    {
        //Retail     / ISO       / 7.68GiB / 2 Images joined with no 2nd iso header
        [Fact]
        public void Ebpx_Onaq_7_HFN_7z_ConvertZso()
        {
            string fileName = @"Ebpx Onaq 7 (HFN).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Ebpx_Onaq_7_HFN_7z_ConvertZso_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Ebpx Onaq 7 (HFN).7z//Ebpx Onaq 7 (HFN).iso", f.FriendlyFullPath.Replace(f.BasePath, ""));
            Assert.Equal("Ebpx Onaq 7 (HFN)", f.CleanName);
            Assert.Equal("Ebpx Onaq 7 (HFN)", f.Name);
            ...
            Assert.Equal("Ebpx Onaq 7 (HFN).iso", f.ImageFiles[0].FileName);
            Assert.Equal("Ebpx Onaq 7 (HFN)", f.ImageFiles[0].NameOnly);
            Assert.Equal(".iso", f.ImageFiles[0].Extension);
            Assert.Equal(0x1eb6d0000L, f.ImageFiles[0].Size);
            ...
            Assert.Equal("Ebpx Onaq 7 (HFN).7z", f.ArchiveFiles[0].FileName);
            Assert.Equal("Ebpx Onaq 7 (HFN)", f.ArchiveFiles[0].NameOnly);
            Assert.Equal(".7z", f.ArchiveFiles[0].Extension);
            Assert.Equal(0x3ed3cL, f.ArchiveFiles[0].Size);
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Ebpx Onaq 7 (HFN).zso", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.NotNull(r.InFileParts);
            Assert.Equal(1, r.InFileParts.Length);
            Assert.Equal(0x1eb6d0000L, r.InFileParts[0].Size);
            Assert.NotNull(r.InFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:4865225C, Md5:0D99A8B9D37CB61037352B7CA46D6CDD, Sha1:4BB1A32E68D9278F5B321FF3AF88EABB39DD43B5, XxHash:4230BEFAA49F2F0F", r.InFileParts[0].Checksums.ToString(true, true));
            Assert.Null(r.InFileParts[0].FileName);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x6b825c8L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:04F749BF", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Ebpx Onaq 7 (HFN).zso~", r.OutFileParts[0].FileName);
            Assert.NotNull(r.ResultCrc);
            Assert.Equal(0x4865225cU, r.ResultCrc.Value);
            Assert.NotNull(r.ResultSize);
            Assert.Equal(0x1eb6d0000L, r.ResultSize.Value);
            ...
            Assert.Equal(0x1eb6d0000L, t.Size);
            Assert.Equal(0x4865225cU, t.CRC);
            ...
            Assert.Equal("Ebpx Onaq 7 (HFN)", t.Name);
            ...
            Assert.Equal("Ebpx Onaq 7 (HFN).zso", t.OutFileName);
            Assert.Null(t.OutKeyFilePath);
            Assert.NotNull(t.OutScanFilePath);
            Assert.Equal(Path.Combine(basePath, "Ebpx Onaq 7 (HFN).nkit.yaml"), t.OutScanFilePath);
            ...
            Assert.Equal(0x6b825c8L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:04F749BF", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Ebpx Onaq 7 (HFN).zso~", t.StepFiles[0].FileName);
            ...
            Assert.Equal("Ebpx Onaq 7 (HFN)", t.Scan.Name);
            Assert.Equal(SystemType.PS2, f.SystemType);
            Assert.Equal(0x4865225cU, t.Scan.Crc);
            Assert.Equal(0x4865225cU, t.Scan.CrcDecrypted);
            Assert.Equal(0x1eb6d0000L, t.Scan.Size);
            Assert.Equal(71, t.Scan.VirtualFsTotalFileCount);
            ...
            Assert.Equal("1EB6D0000", t.Scan.Properties["Size"].ToXmlValue());
            Assert.NotNull(t.Scan.Properties["CRC"].ToXmlValue());
            Assert.Equal("4865225C", t.Scan.Properties["CRC"].ToXmlValue());
            ...
            Assert.Equal("BE054861", t.Scan.Areas[0].AreaInfo.Properties["HeaderCrc"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["HeaderXxHash"].ToXmlValue());
            Assert.Equal("AA0876830B4145BF", t.Scan.Areas[0].AreaInfo.Properties["HeaderXxHash"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            Assert.Equal("0001F1550", t.Scan.Areas[0].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            ...
            Assert.Equal(0x4d921d66U, t.Scan.Areas[0].Crc);
            Assert.Equal(0x4d921d66U, t.Scan.Areas[0].CrcDecrypted);
            Assert.Equal(0xf8aa8000L, t.Scan.Areas[0].Size);
            ...
            Assert.Equal(27, t_ScanTypes0[FsType.Iso9660]);
            Assert.Equal(54, t_ScanTypes0[FsType.Udf]);
            ...
            Assert.Equal("000008000", t.Scan.Areas[1].AreaInfo.Properties["SessionOffsetBase"].ToXmlValue());
            ...
            Assert.Equal("0001E5860", t.Scan.Areas[1].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            ...
            Assert.Equal(0x022c496cU, t.Scan.Areas[1].Crc);
            Assert.Equal(0x022c496cU, t.Scan.Areas[1].CrcDecrypted);
            Assert.Equal(0xf2c28000L, t.Scan.Areas[1].Size);
            Dictionary<FsType, int> t_ScanTypes1 = WipedImageTestsBase.GetIsoFsTypes(t.Scan.Areas[1]);
            Assert.Equal(3, t_ScanTypes1.Count);
            Assert.Equal(9, t_ScanTypes1[FsType.Iso9660]);
            Assert.Equal(1, t_ScanTypes1[FsType.System]);
            Assert.Equal(12, t_ScanTypes1[FsType.Udf]);
