...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps2_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Ebpx_Onaq_7_HFN_7z_Expand()
        {
            string fileName = @"Ebpx Onaq 7 (HFN).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Ebpx_Onaq_7_HFN_7z_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Ebpx Onaq 7 (HFN).iso", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x1eb6d0000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:4865225C", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Ebpx Onaq 7 (HFN).iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Ebpx Onaq 7 (HFN).iso", t.OutFileName);
            ...
            Assert.Equal(0x1eb6d0000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:4865225C", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Ebpx Onaq 7 (HFN).iso~", t.StepFiles[0].FileName);
