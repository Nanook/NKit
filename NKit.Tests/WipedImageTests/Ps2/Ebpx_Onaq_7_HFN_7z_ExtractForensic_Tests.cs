...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps2_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Ebpx_Onaq_7_HFN_7z_ExtractForensic()
        {
            string fileName = @"Ebpx Onaq 7 (HFN).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Ebpx_Onaq_7_HFN_7z_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Ebpx Onaq 7 (HFN)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Ebpx Onaq 7 (HFN)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Ebpx_Onaq_7_HFN_7z_ExtractForensic_Tests.txt"));
