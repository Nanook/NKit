...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps2_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Vpb_Rhebcr_Ra_Se_Qr_Rf_Vg_7z_Expand()
        {
            string fileName = @"Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Vpb_Rhebcr_Ra_Se_Qr_Rf_Vg_7z_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).iso", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x361a8000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:16422783", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).iso", t.OutFileName);
            ...
            Assert.Equal(0x361a8000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:16422783", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).iso~", t.StepFiles[0].FileName);
