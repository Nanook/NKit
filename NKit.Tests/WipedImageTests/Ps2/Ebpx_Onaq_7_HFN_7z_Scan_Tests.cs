...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps2_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Ebpx_Onaq_7_HFN_7z_Scan()
        {
            string fileName = @"Ebpx Onaq 7 (HFN).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Ebpx_Onaq_7_HFN_7z_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Ebpx Onaq 7 (HFN).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Ebpx Onaq 7 (HFN)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Ebpx Onaq 7 (HFN)", t.StepFiles[0].FileName);
