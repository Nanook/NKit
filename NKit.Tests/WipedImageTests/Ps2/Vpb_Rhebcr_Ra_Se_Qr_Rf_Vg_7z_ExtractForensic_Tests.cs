...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps2_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Vpb_Rhebcr_Ra_Se_Qr_Rf_Vg_7z_ExtractForensic()
        {
            string fileName = @"Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Vpb_Rhebcr_Ra_Se_Qr_Rf_Vg_7z_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Vpb_Rhebcr_Ra_Se_Qr_Rf_Vg_7z_ExtractForensic_Tests.txt"));
