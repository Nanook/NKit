...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps2_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Penml_Gnkv_HFN_zip_Scan()
        {
            string fileName = @"Penml Gnkv (HFN).zip";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Penml_Gnkv_HFN_zip_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Penml Gnkv (HFN).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Penml Gnkv (HFN)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Penml Gnkv (HFN)", t.StepFiles[0].FileName);
