...
namespace NKit.Tests.Full.Wiped
{
    ...
    {
        //Retail     / CUE       / 715MiB  / CD with UDF and ISO9660
        [Fact]
        public void Penml_Gnkv_HFN_zip_ConvertCue()
        {
            string fileName = @"Penml Gnkv (HFN).zip";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Penml_Gnkv_HFN_zip_ConvertCue_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Penml Gnkv (HFN).zip//Penml Gnkv (HFN).cue", f.FriendlyFullPath.Replace(f.BasePath, ""));
            Assert.Equal("Penml Gnkv (HFN)", f.CleanName);
            Assert.Equal("Penml Gnkv (HFN)", f.Name);
            ...
            Assert.Equal("Penml Gnkv (HFN).bin", f.ImageFiles[0].FileName);
            Assert.Equal("Penml Gnkv (HFN)", f.ImageFiles[0].NameOnly);
            Assert.Equal(".bin", f.ImageFiles[0].Extension);
            Assert.Equal(0x2cb614f0L, f.ImageFiles[0].Size);
            ...
            Assert.Equal("Penml Gnkv (HFN).zip", f.ArchiveFiles[0].FileName);
            Assert.Equal("Penml Gnkv (HFN)", f.ArchiveFiles[0].NameOnly);
            Assert.Equal(".zip", f.ArchiveFiles[0].Extension);
            Assert.Equal(0x96e3bL, f.ArchiveFiles[0].Size);
            Assert.False(f.ArchiveFiles[0].IsArchived);
            Assert.Null(f.Key);
            // f.IndexFile IndexFile Test
            Assert.NotNull(f.IndexFile);
            Assert.Equal(0x12a072ccU, f.IndexFile.Crc);
            ...
            Assert.Equal(0x52L, f.IndexFile.Size);
            ...
            Assert.Equal("Penml Gnkv (HFN).cue", f.IndexFile.FileName);
            Assert.NotNull(f.IndexFile.NameOnly);
            Assert.Equal("Penml Gnkv (HFN)", f.IndexFile.NameOnly);
            ...
            Assert.Equal(318933, f.IndexFile.Items[0].Blocks);
            ...
            Assert.Equal(0x2cb614f0L, f.IndexFile.Items[0].Size);
            ...
            Assert.Equal("Penml Gnkv (HFN).bin", f.IndexFile.Items[0].FileName);
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Penml Gnkv (HFN)", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(2, r.OutFileParts.Length);
            Assert.Equal(0x2cb614f0L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:2FE76192", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Penml Gnkv (HFN).bin", r.OutFileParts[0].FileName);
            Assert.Equal(0x52L, r.OutFileParts[1].Size);
            Assert.NotNull(r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.Equal("Crc32:12A072CC", r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[1].FileName);
            Assert.Equal("Penml Gnkv (HFN).cue", r.OutFileParts[1].FileName);
            Assert.NotNull(r.ResultCrc);
            Assert.Equal(0x2fe76192U, r.ResultCrc.Value);
            Assert.NotNull(r.ResultSize);
            Assert.Equal(0x2cb614f0L, r.ResultSize.Value);
            ...
            Assert.Equal(0x2cb614f0L, t.Size);
            Assert.Equal(0x2fe76192U, t.CRC);
            ...
            Assert.Equal(Path.Combine(basePath, "Penml Gnkv (HFN)"), t.OutPath);
            Assert.NotNull(t.Name);
            Assert.Equal("Penml Gnkv (HFN)", t.Name);
            ...
            Assert.Equal(Path.Combine(basePath, "Penml Gnkv (HFN).nkit.yaml"), t.OutScanFilePath);
            ...
            Assert.Equal(0x2cb614f0L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:2FE76192", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Penml Gnkv (HFN).bin", t.StepFiles[0].FileName);
            Assert.Equal(0x52L, t.StepFiles[1].Size);
            ...
            Assert.Equal("Crc32:12A072CC", t.StepFiles[1].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[1].FileName);
            Assert.Equal("Penml Gnkv (HFN).cue", t.StepFiles[1].FileName);
            ...
            Assert.Equal("Penml Gnkv (HFN)", t.Scan.Name);
            Assert.Equal(SystemType.PS2, f.SystemType);
            Assert.Equal(0x2fe76192U, t.Scan.Crc);
            Assert.Equal(0x2fe76192U, t.Scan.CrcDecrypted);
            Assert.Equal(0x2cb614f0L, t.Scan.Size);
            Assert.Equal(101, t.Scan.VirtualFsTotalFileCount);
            ...
            Assert.Equal("02CB614F0", t.Scan.Properties["Size"].ToXmlValue());
            Assert.NotNull(t.Scan.Properties["CRC"].ToXmlValue());
            Assert.Equal("2FE76192", t.Scan.Properties["CRC"].ToXmlValue());
            ...
            Assert.Equal("74912", t.Scan.Areas[0].AreaInfo.Properties["Mode2Form1"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["Mode2Form2"].ToXmlValue());
            Assert.Equal("244020", t.Scan.Areas[0].AreaInfo.Properties["Mode2Form2"].ToXmlValue());
            ...
            Assert.Equal("C240E542", t.Scan.Areas[0].AreaInfo.Properties["HeaderCrc"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["HeaderXxHash"].ToXmlValue());
            Assert.Equal("DEE32AF6337067BA", t.Scan.Areas[0].AreaInfo.Properties["HeaderXxHash"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            Assert.Equal("00004DDD5", t.Scan.Areas[0].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            ...
            Assert.Equal(0x2fe76192U, t.Scan.Areas[0].Crc);
            Assert.Equal(0x2fe76192U, t.Scan.Areas[0].CrcDecrypted);
            Assert.Equal(0x2cb614f0L, t.Scan.Areas[0].Size);
            ...
            Assert.Equal(85, t_ScanTypes0[FsType.Iso9660]);
