...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps2_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Ebpx_Onaq_7_HFN_7z_Extract()
        {
            string fileName = @"Ebpx Onaq 7 (HFN).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Ebpx_Onaq_7_HFN_7z_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Ebpx_Onaq_7_HFN_7z_Extract_Tests.txt"));
