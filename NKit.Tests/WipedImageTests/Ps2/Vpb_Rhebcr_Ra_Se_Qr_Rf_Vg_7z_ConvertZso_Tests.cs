...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps2_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Vpb_Rhebcr_Ra_Se_Qr_Rf_Vg_7z_ConvertZso()
        {
            string fileName = @"Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Vpb_Rhebcr_Ra_Se_Qr_Rf_Vg_7z_ConvertZso_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).zso", r.FinalName);
            ...
            Assert.Equal(0xaff0fdL, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:4B663FA0", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).zso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).zso", t.OutFileName);
            ...
            Assert.Equal(0xaff0fdL, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:4B663FA0", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).zso~", t.StepFiles[0].FileName);
