...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps2_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Penml_Gnkv_HFN_zip_ExtractForensic()
        {
            string fileName = @"Penml Gnkv (HFN).zip";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Penml_Gnkv_HFN_zip_ExtractForensic_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Penml_Gnkv_HFN_zip_ExtractForensic_Tests.txt"));
