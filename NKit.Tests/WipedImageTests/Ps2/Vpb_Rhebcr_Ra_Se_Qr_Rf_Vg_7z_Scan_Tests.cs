...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps2_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Vpb_Rhebcr_Ra_Se_Qr_Rf_Vg_7z_Scan()
        {
            string fileName = @"Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps2"));
            string outFolderName = $"Ps2_Vpb_Rhebcr_Ra_Se_Qr_Rf_Vg_7z_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Vpb (Rhebcr) (Ra,Se,Qr,Rf,Vg)", t.StepFiles[0].FileName);
