...
namespace NKit.Tests.Full.Wiped
{
    ...
    public partial class WipedImage_WiiU_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Yrtraq_bs_Mryqn_Gur_Oerngu_bs_gur_Jvyq_HFN_Ra_Se_Rf_nkds_Extract()
        {
            ...
            string outFolderName = $"WiiU_Yrtraq_bs_Mryqn_Gur_Oerngu_bs_gur_Jvyq_HFN_Ra_Se_Rf_nkds_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Yrtraq_bs_Mryqn_Gur_Oerngu_bs_gur_Jvyq_HFN_Ra_Se_Rf_nkds_Extract_Tests.txt"));
