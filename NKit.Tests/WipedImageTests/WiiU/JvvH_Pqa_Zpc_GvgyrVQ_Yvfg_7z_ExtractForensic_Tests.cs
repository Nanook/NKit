...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_WiiU_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void JvvH_Pqa_Zpc_GvgyrVQ_Yvfg_7z_ExtractForensic()
        {
            string fileName = @"JvvH_Pqa_Zpc_GvgyrVQ_Yvfg.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "WiiU"));
            string outFolderName = $"WiiU_JvvH_Pqa_Zpc_GvgyrVQ_Yvfg_7z_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("JvvH_Pqa_Zpc_GvgyrVQ_Yvfg", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "JvvH_Pqa_Zpc_GvgyrVQ_Yvfg"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "JvvH_Pqa_Zpc_GvgyrVQ_Yvfg_7z_ExtractForensic_Tests.txt"));
