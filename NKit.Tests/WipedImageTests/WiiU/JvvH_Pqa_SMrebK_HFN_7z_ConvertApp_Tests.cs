...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_WiiU_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void JvvH_Pqa_SMrebK_HFN_7z_ConvertApp()
        {
            string fileName = @"JvvH_Pqa_SMrebK_HFN.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "WiiU"));
            string outFolderName = $"WiiU_JvvH_Pqa_SMrebK_HFN_7z_ConvertApp_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Crc32:80F771D1", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("0000000a.app", r.OutFileParts[0].FileName);
            Assert.Equal(0x8000L, r.OutFileParts[1].Size);
            Assert.NotNull(r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.Equal("Crc32:D6AE52E2", r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[1].FileName);
            Assert.Equal("0000000b.app", r.OutFileParts[1].FileName);
            Assert.Equal(0x8000L, r.OutFileParts[2].Size);
            Assert.NotNull(r.OutFileParts[2].Checksums.ToString(true, true));
            Assert.Equal("Crc32:EADD60FF", r.OutFileParts[2].Checksums.ToString(true, true));
            ...
            Assert.Equal("0000000c.app", r.OutFileParts[3].FileName);
            ...
            Assert.Equal(0x1250000L, r.OutFileParts[7].Size);
            Assert.NotNull(r.OutFileParts[7].Checksums.ToString(true, true));
            Assert.Equal("Crc32:5267358F", r.OutFileParts[7].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[7].FileName);
            Assert.Equal("00000007.app", r.OutFileParts[7].FileName);
            Assert.Equal(0x180000L, r.OutFileParts[8].Size);
            Assert.NotNull(r.OutFileParts[8].Checksums.ToString(true, true));
            Assert.Equal("Crc32:73D405B9", r.OutFileParts[8].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[8].FileName);
            Assert.Equal("0000000d.app", r.OutFileParts[8].FileName);
            Assert.Equal(0x1aa0000L, r.OutFileParts[9].Size);
            Assert.NotNull(r.OutFileParts[9].Checksums.ToString(true, true));
            Assert.Equal("Crc32:5369AC1A", r.OutFileParts[9].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[9].FileName);
            Assert.Equal("0000000e.app", r.OutFileParts[9].FileName);
            ...
            Assert.Equal("Crc32:BF5AA595", r.OutFileParts[12].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:F099B7CA", r.OutFileParts[13].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[13].FileName);
            Assert.Equal("0000000c.h3", r.OutFileParts[13].FileName);
            Assert.Equal(0x14L, r.OutFileParts[14].Size);
            Assert.NotNull(r.OutFileParts[14].Checksums.ToString(true, true));
            Assert.Equal("Crc32:E1958DC4", r.OutFileParts[14].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:614F342A", r.OutFileParts[15].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:B62272AE", r.OutFileParts[16].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:E5B5E975", r.OutFileParts[17].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:892938B5", r.OutFileParts[18].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[18].FileName);
            Assert.Equal("0000000e.h3", r.OutFileParts[18].FileName);
            ...
            Assert.Equal("Crc32:80F771D1", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("0000000a.app", t.StepFiles[0].FileName);
            ...
            Assert.Equal("Crc32:D6AE52E2", t.StepFiles[1].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[1].FileName);
            Assert.Equal("0000000b.app", t.StepFiles[1].FileName);
            ...
            Assert.Equal("Crc32:EADD60FF", t.StepFiles[2].Checksums.ToString(true, true));
            ...
            Assert.Equal("0000000c.app", t.StepFiles[3].FileName);
            ...
            Assert.Equal(0x1250000L, t.StepFiles[7].Size);
            ...
            Assert.Equal("Crc32:5267358F", t.StepFiles[7].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[7].FileName);
            Assert.Equal("00000007.app", t.StepFiles[7].FileName);
            Assert.Equal(0x180000L, t.StepFiles[8].Size);
            ...
            Assert.Equal("Crc32:73D405B9", t.StepFiles[8].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[8].FileName);
            Assert.Equal("0000000d.app", t.StepFiles[8].FileName);
            Assert.Equal(0x1aa0000L, t.StepFiles[9].Size);
            ...
            Assert.Equal("Crc32:5369AC1A", t.StepFiles[9].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[9].FileName);
            Assert.Equal("0000000e.app", t.StepFiles[9].FileName);
            ...
            Assert.Equal("Crc32:BF5AA595", t.StepFiles[12].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:F099B7CA", t.StepFiles[13].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[13].FileName);
            Assert.Equal("0000000c.h3", t.StepFiles[13].FileName);
            ...
            Assert.Equal("Crc32:E1958DC4", t.StepFiles[14].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:614F342A", t.StepFiles[15].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:B62272AE", t.StepFiles[16].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:E5B5E975", t.StepFiles[17].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:892938B5", t.StepFiles[18].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[18].FileName);
            Assert.Equal("0000000e.h3", t.StepFiles[18].FileName);
