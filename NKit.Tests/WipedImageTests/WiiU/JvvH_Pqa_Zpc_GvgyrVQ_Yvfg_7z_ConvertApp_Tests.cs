...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_WiiU_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void JvvH_Pqa_Zpc_GvgyrVQ_Yvfg_7z_ConvertApp()
        {
            string fileName = @"JvvH_Pqa_Zpc_GvgyrVQ_Yvfg.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "WiiU"));
            string outFolderName = $"WiiU_JvvH_Pqa_Zpc_GvgyrVQ_Yvfg_7z_ConvertApp_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("JvvH_Pqa_Zpc_GvgyrVQ_Yvfg [5550556E65513555][rev6]", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(8, r.OutFileParts.Length);
            Assert.Equal(0x160L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:4EFE8817", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("00000009.app", r.OutFileParts[0].FileName);
            Assert.Equal(0x290L, r.OutFileParts[1].Size);
            Assert.NotNull(r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.Equal("Crc32:3696AC7B", r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[1].FileName);
            Assert.Equal("0000000a.app", r.OutFileParts[1].FileName);
            Assert.Equal(0xef0L, r.OutFileParts[2].Size);
            Assert.NotNull(r.OutFileParts[2].Checksums.ToString(true, true));
            Assert.Equal("Crc32:5029EF34", r.OutFileParts[2].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[2].FileName);
            Assert.Equal("00000002.app", r.OutFileParts[2].FileName);
            Assert.Equal(0x10000L, r.OutFileParts[3].Size);
            Assert.NotNull(r.OutFileParts[3].Checksums.ToString(true, true));
            Assert.Equal("Crc32:FB5BBEDE", r.OutFileParts[3].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[3].FileName);
            Assert.Equal("0000000b.app", r.OutFileParts[3].FileName);
            Assert.Equal(0x700L, r.OutFileParts[4].Size);
            Assert.NotNull(r.OutFileParts[4].Checksums.ToString(true, true));
            Assert.Equal("Crc32:44437DD4", r.OutFileParts[4].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[4].FileName);
            Assert.Equal("title.cert", r.OutFileParts[4].FileName);
            Assert.Equal(0x350L, r.OutFileParts[5].Size);
            Assert.NotNull(r.OutFileParts[5].Checksums.ToString(true, true));
            Assert.Equal("Crc32:29C8D735", r.OutFileParts[5].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[5].FileName);
            Assert.Equal("title.tik", r.OutFileParts[5].FileName);
            Assert.Equal(0x12c4L, r.OutFileParts[6].Size);
            Assert.NotNull(r.OutFileParts[6].Checksums.ToString(true, true));
            Assert.Equal("Crc32:45F6FD99", r.OutFileParts[6].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[6].FileName);
            Assert.Equal("title.tmd", r.OutFileParts[6].FileName);
            Assert.Equal(0x14L, r.OutFileParts[7].Size);
            Assert.NotNull(r.OutFileParts[7].Checksums.ToString(true, true));
            Assert.Equal("Crc32:89998A0E", r.OutFileParts[7].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[7].FileName);
            Assert.Equal("0000000b.h3", r.OutFileParts[7].FileName);
            ...
            Assert.Equal(Path.Combine(basePath, "JvvH_Pqa_Zpc_GvgyrVQ_Yvfg [5550556E65513555][rev6]"), t.OutPath);
            ...
            Assert.Equal(8, t.StepFiles.Count);
            Assert.Equal(0x160L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:4EFE8817", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("00000009.app", t.StepFiles[0].FileName);
            Assert.Equal(0x290L, t.StepFiles[1].Size);
            ...
            Assert.Equal("Crc32:3696AC7B", t.StepFiles[1].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[1].FileName);
            Assert.Equal("0000000a.app", t.StepFiles[1].FileName);
            Assert.Equal(0xef0L, t.StepFiles[2].Size);
            ...
            Assert.Equal("Crc32:5029EF34", t.StepFiles[2].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[2].FileName);
            Assert.Equal("00000002.app", t.StepFiles[2].FileName);
            Assert.Equal(0x10000L, t.StepFiles[3].Size);
            ...
            Assert.Equal("Crc32:FB5BBEDE", t.StepFiles[3].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[3].FileName);
            Assert.Equal("0000000b.app", t.StepFiles[3].FileName);
            Assert.Equal(0x700L, t.StepFiles[4].Size);
            ...
            Assert.Equal("Crc32:44437DD4", t.StepFiles[4].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[4].FileName);
            Assert.Equal("title.cert", t.StepFiles[4].FileName);
            Assert.Equal(0x350L, t.StepFiles[5].Size);
            ...
            Assert.Equal("Crc32:29C8D735", t.StepFiles[5].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[5].FileName);
            Assert.Equal("title.tik", t.StepFiles[5].FileName);
            Assert.Equal(0x12c4L, t.StepFiles[6].Size);
            Assert.True(t.StepFiles[6].IsIndex);
            Assert.False(t.StepFiles[6].IsImageName);
            Assert.NotNull(t.StepFiles[6].Checksums.ToString(true, true));
            Assert.Equal("Crc32:45F6FD99", t.StepFiles[6].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[6].FileName);
            Assert.Equal("title.tmd", t.StepFiles[6].FileName);
            Assert.Equal(0x14L, t.StepFiles[7].Size);
            ...
            Assert.Equal("Crc32:89998A0E", t.StepFiles[7].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[7].FileName);
            Assert.Equal("0000000b.h3", t.StepFiles[7].FileName);
