...
namespace NKit.Tests.Full.Wiped
{
    ...
    public partial class WipedImage_WiiU_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Yrtraq_bs_Mryqn_Gur_Oerngu_bs_gur_Jvyq_HFN_Ra_Se_Rf_nkds_ExtractForensic()
        {
            ...
            string outFolderName = $"WiiU_Yrtraq_bs_Mryqn_Gur_Oerngu_bs_gur_Jvyq_HFN_Ra_Se_Rf_nkds_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Yrtraq bs Mryqn, Gur - Oerngu bs gur Jvyq (HFN) (Ra,Se,Rf)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Yrtraq bs Mryqn, Gur - Oerngu bs gur Jvyq (HFN) (Ra,Se,Rf)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Yrtraq_bs_Mryqn_Gur_Oerngu_bs_gur_Jvyq_HFN_Ra_Se_Rf_nkds_ExtractForensic_Tests.txt"));
