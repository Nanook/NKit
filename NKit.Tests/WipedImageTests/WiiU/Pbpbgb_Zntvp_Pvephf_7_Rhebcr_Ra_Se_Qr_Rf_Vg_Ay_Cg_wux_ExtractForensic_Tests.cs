...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_WiiU_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Pbpbgb_Zntvp_Pvephf_7_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_Cg_wux_ExtractForensic()
        {
            ...
            string outFolderName = $"WiiU_Pbpbgb_Zntvp_Pvephf_7_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_Cg_wux_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Pbpbgb Zntvp Pvephf 7 (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay,Cg)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Pbpbgb Zntvp Pvephf 7 (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay,Cg)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Pbpbgb_Zntvp_Pvephf_7_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_Cg_wux_ExtractForensic_Tests.txt"));
