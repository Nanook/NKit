...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_WiiU_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void JvvH_PNG_V_wux_ExtractForensic()
        {
            string fileName = @"JvvH_PNG-V.wux";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "WiiU"));
            string outFolderName = $"WiiU_JvvH_PNG_V_wux_ExtractForensic_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "JvvH_PNG_V_wux_ExtractForensic_Tests.txt"));
