...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_WiiU_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void JvvH_Pqa_Zpc_GvgyrVQ_Yvfg_7z_Extract()
        {
            string fileName = @"JvvH_Pqa_Zpc_GvgyrVQ_Yvfg.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "WiiU"));
            string outFolderName = $"WiiU_JvvH_Pqa_Zpc_GvgyrVQ_Yvfg_7z_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "JvvH_Pqa_Zpc_GvgyrVQ_Yvfg_7z_Extract_Tests.txt"));
