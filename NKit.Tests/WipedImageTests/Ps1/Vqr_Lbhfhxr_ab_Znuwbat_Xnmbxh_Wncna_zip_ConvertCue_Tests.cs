...
{
    public partial class WipedImage_Ps1_Tests : WipedImageTestsBase
    {
        //Retail     / CUE (zip) / 527MiB  / Bad Date in Directory Entry
        [Fact]
        public void Vqr_Lbhfhxr_ab_Znuwbat_Xnmbxh_Wncna_zip_ConvertCue()
        {
            string fileName = @"Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).zip";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps1"));
            string outFolderName = $"Ps1_Vqr_Lbhfhxr_ab_Znuwbat_Xnmbxh_Wncna_zip_ConvertCue_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).zip//Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).cue", f.FriendlyFullPath.Replace(f.BasePath, ""));
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna)", f.CleanName);
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna)", f.Name);
            Assert.Equal(SourceImageType.IsoMode2, f.ImageType);
            Assert.Equal(SourceFileResult.Valid, f.Status);
            Assert.Equal(SystemType.PS1, f.SystemType);
            ...
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).bin", f.ImageFiles[0].FileName);
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna)", f.ImageFiles[0].NameOnly);
            Assert.Equal(".bin", f.ImageFiles[0].Extension);
            Assert.Equal(0x20f1c420L, f.ImageFiles[0].Size);
            ...
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).zip", f.ArchiveFiles[0].FileName);
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna)", f.ArchiveFiles[0].NameOnly);
            Assert.Equal(".zip", f.ArchiveFiles[0].Extension);
            Assert.Equal(0x74d85L, f.ArchiveFiles[0].Size);
            Assert.False(f.ArchiveFiles[0].IsArchived);
            Assert.Null(f.Key);
            // f.IndexFile IndexFile Test
            Assert.NotNull(f.IndexFile);
            Assert.Equal(0x3bc139caU, f.IndexFile.Crc);
            ...
            Assert.Equal(0x67L, f.IndexFile.Size);
            ...
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).cue", f.IndexFile.FileName);
            Assert.NotNull(f.IndexFile.NameOnly);
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna)", f.IndexFile.NameOnly);
            ...
            Assert.Equal(234998, f.IndexFile.Items[0].Blocks);
            ...
            Assert.Equal(0x20f1c420L, f.IndexFile.Items[0].Size);
            ...
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).bin", f.IndexFile.Items[0].FileName);
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna)", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(2, r.OutFileParts.Length);
            Assert.Equal(0x20f1c420L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:C92B437B", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).bin", r.OutFileParts[0].FileName);
            Assert.Equal(0x67L, r.OutFileParts[1].Size);
            Assert.NotNull(r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.Equal("Crc32:3BC139CA", r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[1].FileName);
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).cue", r.OutFileParts[1].FileName);
            Assert.NotNull(r.ResultCrc);
            Assert.Equal(0xc92b437bU, r.ResultCrc.Value);
            Assert.NotNull(r.ResultSize);
            Assert.Equal(0x20f1c420L, r.ResultSize.Value);
            ...
            Assert.Equal(SystemType.PS1, t.System);
            Assert.Equal(TaskType.Convert, t.Task);
            Assert.Equal(0x20f1c420L, t.Size);
            Assert.Equal(0xc92b437bU, t.CRC);
            ...
            Assert.Equal(Path.Combine(basePath, "Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna)"), t.OutPath);
            Assert.NotNull(t.Name);
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna)", t.Name);
            ...
            Assert.Equal(Path.Combine(basePath, "Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).nkit.yaml"), t.OutScanFilePath);
            ...
            Assert.Equal(0x20f1c420L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:C92B437B", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).bin", t.StepFiles[0].FileName);
            Assert.Equal(0x67L, t.StepFiles[1].Size);
            ...
            Assert.Equal("Crc32:3BC139CA", t.StepFiles[1].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[1].FileName);
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).cue", t.StepFiles[1].FileName);
            ...
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna)", t.Scan.Name);
            Assert.Equal(SystemType.PS1, f.SystemType);
            Assert.Equal(0xc92b437bU, t.Scan.Crc);
            Assert.Equal(0xc92b437bU, t.Scan.CrcDecrypted);
            Assert.Equal(0x20f1c420L, t.Scan.Size);
            Assert.Equal(55, t.Scan.VirtualFsTotalFileCount);
            Assert.Equal(3, t.Scan.VirtualFsTotalFoldersCount);
            Assert.NotNull(t.Scan.Properties["System"].ToXmlValue());
            Assert.Equal("PS1", t.Scan.Properties["System"].ToXmlValue());
            ...
            Assert.Equal("020F1C420", t.Scan.Properties["Size"].ToXmlValue());
            Assert.NotNull(t.Scan.Properties["CRC"].ToXmlValue());
            Assert.Equal("C92B437B", t.Scan.Properties["CRC"].ToXmlValue());
            ...
            Assert.Equal("129180", t.Scan.Areas[0].AreaInfo.Properties["Mode2Form1"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["Mode2Form2"].ToXmlValue());
            Assert.Equal("105817", t.Scan.Areas[0].AreaInfo.Properties["Mode2Form2"].ToXmlValue());
            ...
            Assert.Equal("DA466CF5", t.Scan.Areas[0].AreaInfo.Properties["HeaderCrc"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["HeaderXxHash"].ToXmlValue());
            Assert.Equal("1134C7AECA6B4B03", t.Scan.Areas[0].AreaInfo.Properties["HeaderXxHash"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            Assert.Equal("0000395F6", t.Scan.Areas[0].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            ...
            Assert.Equal(0xc92b437bU, t.Scan.Areas[0].Crc);
            Assert.Equal(0xc92b437bU, t.Scan.Areas[0].CrcDecrypted);
            Assert.Equal(0x20f1c420L, t.Scan.Areas[0].Size);
            ...
            Assert.Equal(51, t_ScanTypes0[FsType.Iso9660]);
