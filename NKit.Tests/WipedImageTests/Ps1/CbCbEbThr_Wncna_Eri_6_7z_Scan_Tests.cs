...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps1_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void CbCbEbThr_Wncna_Eri_6_7z_Scan()
        {
            string fileName = @"CbCbEbThr (Wncna) (Eri 6).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps1"));
            string outFolderName = $"Ps1_CbCbEbThr_Wncna_Eri_6_7z_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6)", t.StepFiles[0].FileName);
