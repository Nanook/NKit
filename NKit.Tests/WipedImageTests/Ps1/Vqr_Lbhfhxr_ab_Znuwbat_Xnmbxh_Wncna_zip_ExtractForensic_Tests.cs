...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps1_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Vqr_Lbhfhxr_ab_Znuwbat_Xnmbxh_Wncna_zip_ExtractForensic()
        {
            string fileName = @"Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).zip";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps1"));
            string outFolderName = $"Ps1_Vqr_Lbhfhxr_ab_Znuwbat_Xnmbxh_Wncna_zip_ExtractForensic_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Vqr_Lbhfhxr_ab_Znuwbat_Xnmbxh_Wncna_zip_ExtractForensic_Tests.txt"));
