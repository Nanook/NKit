...
namespace NKit.Tests.Full.Wiped
{
    ...
    {
        //Retail     / CUE (7z)  / 670MiB  / Directory Enries that point to invalid indexes
        [Fact]
        public void CbCbEbThr_Wncna_Eri_6_7z_ConvertCue()
        {
            string fileName = @"CbCbEbThr (Wncna) (Eri 6).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps1"));
            string outFolderName = $"Ps1_CbCbEbThr_Wncna_Eri_6_7z_ConvertCue_{Guid.NewGuid():N}";
            ...
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6).7z//CbCbEbThr (Wncna) (Eri 6).cue", f.FriendlyFullPath.Replace(f.BasePath, ""));
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6)", f.CleanName);
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6)", f.Name);
            ...
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6).bin", f.ImageFiles[0].FileName);
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6)", f.ImageFiles[0].NameOnly);
            Assert.Equal(".bin", f.ImageFiles[0].Extension);
            Assert.Equal(0x29e3adc0L, f.ImageFiles[0].Size);
            ...
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6).7z", f.ArchiveFiles[0].FileName);
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6)", f.ArchiveFiles[0].NameOnly);
            Assert.Equal(".7z", f.ArchiveFiles[0].Extension);
            Assert.Equal(0xb28a4L, f.ArchiveFiles[0].Size);
            Assert.False(f.ArchiveFiles[0].IsArchived);
            Assert.Null(f.Key);
            // f.IndexFile IndexFile Test
            Assert.NotNull(f.IndexFile);
            Assert.Equal(0x3d835242U, f.IndexFile.Crc);
            ...
            Assert.Equal(0x5bL, f.IndexFile.Size);
            ...
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6).cue", f.IndexFile.FileName);
            Assert.NotNull(f.IndexFile.NameOnly);
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6)", f.IndexFile.NameOnly);
            ...
            Assert.Equal(298804, f.IndexFile.Items[0].Blocks);
            ...
            Assert.Equal(0x29e3adc0L, f.IndexFile.Items[0].Size);
            ...
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6).bin", f.IndexFile.Items[0].FileName);
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6)", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(2, r.OutFileParts.Length);
            Assert.Equal(0x29e3adc0L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:80466B50", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6).bin", r.OutFileParts[0].FileName);
            Assert.Equal(0x5bL, r.OutFileParts[1].Size);
            Assert.NotNull(r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.Equal("Crc32:3D835242", r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[1].FileName);
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6).cue", r.OutFileParts[1].FileName);
            Assert.NotNull(r.ResultCrc);
            Assert.Equal(0x80466b50U, r.ResultCrc.Value);
            Assert.NotNull(r.ResultSize);
            Assert.Equal(0x29e3adc0L, r.ResultSize.Value);
            ...
            Assert.Equal(0x29e3adc0L, t.Size);
            Assert.Equal(0x80466b50U, t.CRC);
            ...
            Assert.Equal(Path.Combine(basePath, "CbCbEbThr (Wncna) (Eri 6)"), t.OutPath);
            Assert.NotNull(t.Name);
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6)", t.Name);
            ...
            Assert.Equal(Path.Combine(basePath, "CbCbEbThr (Wncna) (Eri 6).nkit.yaml"), t.OutScanFilePath);
            ...
            Assert.Equal(0x29e3adc0L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:80466B50", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6).bin", t.StepFiles[0].FileName);
            Assert.Equal(0x5bL, t.StepFiles[1].Size);
            ...
            Assert.Equal("Crc32:3D835242", t.StepFiles[1].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[1].FileName);
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6).cue", t.StepFiles[1].FileName);
            ...
            Assert.Equal("CbCbEbThr (Wncna) (Eri 6)", t.Scan.Name);
            Assert.Equal(SystemType.PS1, f.SystemType);
            Assert.Equal(0x80466b50U, t.Scan.Crc);
            Assert.Equal(0x80466b50U, t.Scan.CrcDecrypted);
            Assert.Equal(0x29e3adc0L, t.Scan.Size);
            Assert.Equal(198, t.Scan.VirtualFsTotalFileCount);
            Assert.Equal(23, t.Scan.VirtualFsTotalFoldersCount);
            ...
            Assert.Equal("029E3ADC0", t.Scan.Properties["Size"].ToXmlValue());
            Assert.NotNull(t.Scan.Properties["CRC"].ToXmlValue());
            Assert.Equal("80466B50", t.Scan.Properties["CRC"].ToXmlValue());
            ...
            Assert.Equal("201709", t.Scan.Areas[0].AreaInfo.Properties["Mode2Form1"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["Mode2Form2"].ToXmlValue());
            Assert.Equal("97094", t.Scan.Areas[0].AreaInfo.Properties["Mode2Form2"].ToXmlValue());
            ...
            Assert.Equal("6AC5F189", t.Scan.Areas[0].AreaInfo.Properties["HeaderCrc"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["HeaderXxHash"].ToXmlValue());
            Assert.Equal("C5A94AE95FDA1AC1", t.Scan.Areas[0].AreaInfo.Properties["HeaderXxHash"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            Assert.Equal("000048F34", t.Scan.Areas[0].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            ...
            Assert.Equal(0x80466b50U, t.Scan.Areas[0].Crc);
            Assert.Equal(0x80466b50U, t.Scan.Areas[0].CrcDecrypted);
            Assert.Equal(0x29e3adc0L, t.Scan.Areas[0].Size);
            Dictionary<FsType, int> t_ScanTypes0 = WipedImageTestsBase.GetIsoFsTypes(t.Scan.Areas[0]);
            Assert.Equal(2, t_ScanTypes0.Count);
            Assert.Equal(125, t_ScanTypes0[FsType.Iso9660]);
