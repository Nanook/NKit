...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps1_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void CbCbEbThr_Wncna_Eri_6_7z_Extract()
        {
            string fileName = @"CbCbEbThr (Wncna) (Eri 6).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps1"));
            string outFolderName = $"Ps1_CbCbEbThr_Wncna_Eri_6_7z_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "CbCbEbThr_Wncna_Eri_6_7z_Extract_Tests.txt"));
