...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps1_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Vqr_Lbhfhxr_ab_Znuwbat_Xnmbxh_Wncna_zip_Scan()
        {
            string fileName = @"Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).zip";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps1"));
            string outFolderName = $"Ps1_Vqr_Lbhfhxr_ab_Znuwbat_Xnmbxh_Wncna_zip_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Vqr Lbhfhxr ab Znuwbat Xnmbxh (Wncna)", t.StepFiles[0].FileName);
