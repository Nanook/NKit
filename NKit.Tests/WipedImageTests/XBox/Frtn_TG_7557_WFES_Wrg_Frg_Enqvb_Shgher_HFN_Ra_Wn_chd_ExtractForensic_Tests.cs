...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_XBox_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Frtn_TG_7557_WFES_Wrg_Frg_Enqvb_Shgher_HFN_Ra_Wn_chd_ExtractForensic()
        {
            ...
            string outFolderName = $"XBox_Frtn_TG_7557_WFES_Wrg_Frg_Enqvb_Shgher_HFN_Ra_Wn_chd_ExtractForensic_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Frtn_TG_7557_WFES_Wrg_Frg_Enqvb_Shgher_HFN_Ra_Wn_chd_ExtractForensic_Tests.txt"));
