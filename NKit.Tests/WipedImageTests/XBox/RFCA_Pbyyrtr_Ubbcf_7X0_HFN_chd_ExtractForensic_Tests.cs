...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_XBox_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void RFCA_Pbyyrtr_Ubbcf_7X0_HFN_chd_ExtractForensic()
        {
            string fileName = @"RFCA Pbyyrtr Ubbcf 7X0 (HFN).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "XBox"));
            string outFolderName = $"XBox_RFCA_Pbyyrtr_Ubbcf_7X0_HFN_chd_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("RFCA Pbyyrtr Ubbcf 7X0 (HFN)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "RFCA Pbyyrtr Ubbcf 7X0 (HFN)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "RFCA_Pbyyrtr_Ubbcf_7X0_HFN_chd_ExtractForensic_Tests.txt"));
