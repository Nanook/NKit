...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void QzP_Qrivy_Znl_Pel_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_Cg_Cy_Eh_Orgn_7z_Extract()
        {
            ...
            string outFolderName = $"Ps3_QzP_Qrivy_Znl_Pel_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_Cg_Cy_Eh_Orgn_7z_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "QzP_Qrivy_Znl_Pel_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_Cg_Cy_Eh_Orgn_7z_Extract_Tests.txt"));
