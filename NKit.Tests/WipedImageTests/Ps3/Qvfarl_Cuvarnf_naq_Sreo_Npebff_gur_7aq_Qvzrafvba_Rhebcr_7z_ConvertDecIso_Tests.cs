...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Qvfarl_Cuvarnf_naq_Sreo_Npebff_gur_7aq_Qvzrafvba_Rhebcr_7z_ConvertDeciso()
        {
            ...
            string outFolderName = $"Ps3_Qvfarl_Cuvarnf_naq_Sreo_Npebff_gur_7aq_Qvzrafvba_Rhebcr_7z_ConvertDeciso_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Qvfarl Cuvarnf naq Sreo - Npebff gur 7aq Qvzrafvba (Rhebcr).dec.iso", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.NotNull(r.InFileParts);
            Assert.Equal(1, r.InFileParts.Length);
            Assert.Equal(0x45eed0000L, r.InFileParts[0].Size);
            Assert.NotNull(r.InFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:83981FC0", r.InFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:281D0816", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Qvfarl Cuvarnf naq Sreo - Npebff gur 7aq Qvzrafvba (Rhebcr).dec.iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Qvfarl Cuvarnf naq Sreo - Npebff gur 7aq Qvzrafvba (Rhebcr).dec.iso", t.OutFileName);
            ...
            Assert.Equal("Crc32:281D0816", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Qvfarl Cuvarnf naq Sreo - Npebff gur 7aq Qvzrafvba (Rhebcr).dec.iso~", t.StepFiles[0].FileName);
