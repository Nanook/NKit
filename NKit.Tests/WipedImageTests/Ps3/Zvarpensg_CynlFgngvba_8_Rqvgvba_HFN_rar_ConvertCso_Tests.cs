...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvarpensg_CynlFgngvba_8_Rqvgvba_HFN_rar_ConvertCso()
        {
            string fileName = @"Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).rar";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps3"));
            string outFolderName = $"Ps3_Zvarpensg_CynlFgngvba_8_Rqvgvba_HFN_rar_ConvertCso_{Guid.NewGuid():N}";
            ...
            Assert.Equal(0x4e8c74L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:044CBCE6", r.OutFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal(0x4e8c74L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:044CBCE6", t.StepFiles[0].Checksums.ToString(true, true));
