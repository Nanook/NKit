...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jr_Qner_Syvegl_Sha_sbe_Nyy_Rhebcr_Nhfgenyvn_Ra_Se_Qr_Rf_Vg_7z_ConvertDeciso()
        {
            ...
            string outFolderName = $"Ps3_Jr_Qner_Syvegl_Sha_sbe_Nyy_Rhebcr_Nhfgenyvn_Ra_Se_Qr_Rf_Vg_7z_ConvertDeciso_{Guid.NewGuid():N}";
            ...
            SystemPresetSettings presets = base.CreatePresets("Convert", @"deciso", inPath, fileName, outFolderName, dats, keys, fixInfo, fixFiles);
            ...
            Assert.Equal("Convert-Iso-DecIso", i.Name);
            ...
            Assert.Equal("deciso", i.Config);
            Assert.NotNull(i.ImageConfig);
            Assert.Equal("deciso", i.ImageConfig);
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jr Qner - Syvegl Sha sbe Nyy (Rhebcr, Nhfgenyvn) (Ra,Se,Qr,Rf,Vg).dec.iso", r.FinalName);
            ...
            Assert.Equal("Crc32:A7FF7E66", r.InFileParts[0].Checksums.ToString(true, true));
            Assert.Null(r.InFileParts[0].FileName);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x55390000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:48561C75", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Jr Qner - Syvegl Sha sbe Nyy (Rhebcr, Nhfgenyvn) (Ra,Se,Qr,Rf,Vg).dec.iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Jr Qner - Syvegl Sha sbe Nyy (Rhebcr, Nhfgenyvn) (Ra,Se,Qr,Rf,Vg).dec.iso", t.OutFileName);
            ...
            Assert.Equal(0x55390000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:48561C75", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Jr Qner - Syvegl Sha sbe Nyy (Rhebcr, Nhfgenyvn) (Ra,Se,Qr,Rf,Vg).dec.iso~", t.StepFiles[0].FileName);
