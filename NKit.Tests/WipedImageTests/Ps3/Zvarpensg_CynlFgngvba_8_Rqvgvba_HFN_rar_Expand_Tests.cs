...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvarpensg_CynlFgngvba_8_Rqvgvba_HFN_rar_Expand()
        {
            string fileName = @"Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).rar";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps3"));
            string outFolderName = $"Ps3_Zvarpensg_CynlFgngvba_8_Rqvgvba_HFN_rar_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).iso", r.FinalName);
            ...
            Assert.Equal("Crc32:DE29F0D7", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).iso", t.OutFileName);
            ...
            Assert.Equal("Crc32:DE29F0D7", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).iso~", t.StepFiles[0].FileName);
