...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvarpensg_CynlFgngvba_8_Rqvgvba_HFN_rar_ConvertDeciso()
        {
            string fileName = @"Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).rar";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps3"));
            string outFolderName = $"Ps3_Zvarpensg_CynlFgngvba_8_Rqvgvba_HFN_rar_ConvertDeciso_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).dec.iso", r.FinalName);
            ...
            Assert.Equal("Crc32:DE29F0D7", r.InFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:927ACFFE", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).dec.iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).dec.iso", t.OutFileName);
            ...
            Assert.Equal("Crc32:927ACFFE", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).dec.iso~", t.StepFiles[0].FileName);
