...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Qvfarl_Cuvarnf_naq_Sreo_Npebff_gur_7aq_Qvzrafvba_Rhebcr_7z_ExtractForensic()
        {
            ...
            string outFolderName = $"Ps3_Qvfarl_Cuvarnf_naq_Sreo_Npebff_gur_7aq_Qvzrafvba_Rhebcr_7z_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Qvfarl Cuvarnf naq Sreo - Npebff gur 7aq Qvzrafvba (Rhebcr)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Qvfarl Cuvarnf naq Sreo - Npebff gur 7aq Qvzrafvba (Rhebcr)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Qvfarl_Cuvarnf_naq_Sreo_Npebff_gur_7aq_Qvzrafvba_Rhebcr_7z_ExtractForensic_Tests.txt"));
