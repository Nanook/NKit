...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jr_Qner_Syvegl_Sha_sbe_Nyy_Rhebcr_Nhfgenyvn_Ra_Se_Qr_Rf_Vg_7z_ConvertCso2()
        {
            ...
            string outFolderName = $"Ps3_Jr_Qner_Syvegl_Sha_sbe_Nyy_Rhebcr_Nhfgenyvn_Ra_Se_Qr_Rf_Vg_7z_ConvertCso2_{Guid.NewGuid():N}";
            ...
            Assert.Equal(0x39b5c4dL, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:8B5AEB21", r.OutFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal(0x39b5c4dL, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:8B5AEB21", t.StepFiles[0].Checksums.ToString(true, true));
