...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvarpensg_CynlFgngvba_8_Rqvgvba_HFN_rar_ExtractForensic()
        {
            string fileName = @"Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).rar";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps3"));
            string outFolderName = $"Ps3_Zvarpensg_CynlFgngvba_8_Rqvgvba_HFN_rar_ExtractForensic_{Guid.NewGuid():N}";
            ...
            Assert.Equal(Path.Combine(basePath, "Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Zvarpensg_CynlFgngvba_8_Rqvgvba_HFN_rar_ExtractForensic_Tests.txt"));
