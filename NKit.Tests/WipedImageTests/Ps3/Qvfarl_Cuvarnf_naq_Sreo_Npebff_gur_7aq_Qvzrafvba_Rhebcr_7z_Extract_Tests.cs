...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Qvfarl_Cuvarnf_naq_Sreo_Npebff_gur_7aq_Qvzrafvba_Rhebcr_7z_Extract()
        {
            ...
            string outFolderName = $"Ps3_Qvfarl_Cuvarnf_naq_Sreo_Npebff_gur_7aq_Qvzrafvba_Rhebcr_7z_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Qvfarl_Cuvarnf_naq_Sreo_Npebff_gur_7aq_Qvzrafvba_Rhebcr_7z_Extract_Tests.txt"));
