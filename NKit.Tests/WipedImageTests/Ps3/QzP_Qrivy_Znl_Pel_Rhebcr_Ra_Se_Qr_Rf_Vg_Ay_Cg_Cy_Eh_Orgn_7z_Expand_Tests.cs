...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void QzP_Qrivy_Znl_Pel_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_Cg_Cy_Eh_Orgn_7z_Expand()
        {
            ...
            string outFolderName = $"Ps3_QzP_Qrivy_Znl_Pel_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_Cg_Cy_Eh_Orgn_7z_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("QzP - Qrivy Znl Pel (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay,Cg,Cy,Eh) (Orgn).iso", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x1b0230000L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:51CAC325", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("QzP - Qrivy Znl Pel (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay,Cg,Cy,Eh) (Orgn).iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("QzP - Qrivy Znl Pel (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay,Cg,Cy,Eh) (Orgn).iso", t.OutFileName);
            ...
            Assert.Equal(0x1b0230000L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:51CAC325", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("QzP - Qrivy Znl Pel (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay,Cg,Cy,Eh) (Orgn).iso~", t.StepFiles[0].FileName);
