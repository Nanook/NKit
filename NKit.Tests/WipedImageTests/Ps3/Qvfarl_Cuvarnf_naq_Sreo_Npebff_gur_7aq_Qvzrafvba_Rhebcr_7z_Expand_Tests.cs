...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Qvfarl_Cuvarnf_naq_Sreo_Npebff_gur_7aq_Qvzrafvba_Rhebcr_7z_Expand()
        {
            ...
            string outFolderName = $"Ps3_Qvfarl_Cuvarnf_naq_Sreo_Npebff_gur_7aq_Qvzrafvba_Rhebcr_7z_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Qvfarl Cuvarnf naq Sreo - Npebff gur 7aq Qvzrafvba (Rhebcr).iso", r.FinalName);
            ...
            Assert.Equal("Crc32:83981FC0", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Qvfarl Cuvarnf naq Sreo - Npebff gur 7aq Qvzrafvba (Rhebcr).iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Qvfarl Cuvarnf naq Sreo - Npebff gur 7aq Qvzrafvba (Rhebcr).iso", t.OutFileName);
            ...
            Assert.Equal("Crc32:83981FC0", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Qvfarl Cuvarnf naq Sreo - Npebff gur 7aq Qvzrafvba (Rhebcr).iso~", t.StepFiles[0].FileName);
