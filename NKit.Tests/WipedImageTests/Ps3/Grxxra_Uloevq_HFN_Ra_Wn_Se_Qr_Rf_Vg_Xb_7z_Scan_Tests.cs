...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Grxxra_Uloevq_HFN_Ra_Wn_Se_Qr_Rf_Vg_Xb_7z_Scan()
        {
            string fileName = @"Grxxra Uloevq (HFN) (Ra,Wn,Se,Qr,Rf,Vg,Xb).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps3"));
            string outFolderName = $"Ps3_Grxxra_Uloevq_HFN_Ra_Wn_Se_Qr_Rf_Vg_Xb_7z_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Grxxra Uloevq (HFN) (Ra,Wn,Se,Qr,Rf,Vg,Xb).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Grxxra Uloevq (HFN) (Ra,Wn,Se,Qr,Rf,Vg,Xb)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Grxxra Uloevq (HFN) (Ra,Wn,Se,Qr,Rf,Vg,Xb)", t.StepFiles[0].FileName);
