...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void QzP_Qrivy_Znl_Pel_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_Cg_Cy_Eh_Orgn_7z_ExtractForensic()
        {
            ...
            string outFolderName = $"Ps3_QzP_Qrivy_Znl_Pel_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_Cg_Cy_Eh_Orgn_7z_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("QzP - Qrivy Znl Pel (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay,Cg,Cy,Eh) (Orgn)", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "QzP - Qrivy Znl Pel (Rhebcr) (Ra,Se,Qr,Rf,Vg,Ay,Cg,Cy,Eh) (Orgn)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "QzP_Qrivy_Znl_Pel_Rhebcr_Ra_Se_Qr_Rf_Vg_Ay_Cg_Cy_Eh_Orgn_7z_ExtractForensic_Tests.txt"));
