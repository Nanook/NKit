...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jr_Qner_Syvegl_Sha_sbe_Nyy_Rhebcr_Nhfgenyvn_Ra_Se_Qr_Rf_Vg_7z_ExtractForensic()
        {
            ...
            string outFolderName = $"Ps3_Jr_Qner_Syvegl_Sha_sbe_Nyy_Rhebcr_Nhfgenyvn_Ra_Se_Qr_Rf_Vg_7z_ExtractForensic_{Guid.NewGuid():N}";
            ...
            Assert.Equal(Path.Combine(basePath, "Jr Qner - Syvegl Sha sbe Nyy (Rhebcr, Nhfgenyvn) (Ra,Se,Qr,Rf,Vg)"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Jr_Qner_Syvegl_Sha_sbe_Nyy_Rhebcr_Nhfgenyvn_Ra_Se_Qr_Rf_Vg_7z_ExtractForensic_Tests.txt"));
