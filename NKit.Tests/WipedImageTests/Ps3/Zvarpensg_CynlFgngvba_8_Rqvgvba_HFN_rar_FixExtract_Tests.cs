...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvarpensg_CynlFgngvba_8_Rqvgvba_HFN_rar_FixExtract()
        {
            string fileName = @"Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN).rar";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps3"));
            string outFolderName = $"Ps3_Zvarpensg_CynlFgngvba_8_Rqvgvba_HFN_rar_FixExtract_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN)", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0xb82cL, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:FF0F3645", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN) [OYHF-86971] [DE29F0D7].ird~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN) [OYHF-86971] [DE29F0D7].ird", t.OutFileName);
            ...
            Assert.Equal(0xb82cL, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:FF0F3645", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Zvarpensg - CynlFgngvba 8 Rqvgvba (HFN) [OYHF-86971] [DE29F0D7].ird~", t.StepFiles[0].FileName);
