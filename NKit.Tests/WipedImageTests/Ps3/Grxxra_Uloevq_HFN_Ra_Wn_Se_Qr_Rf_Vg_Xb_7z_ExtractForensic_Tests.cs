...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Grxxra_Uloevq_HFN_Ra_Wn_Se_Qr_Rf_Vg_Xb_7z_ExtractForensic()
        {
            string fileName = @"Grxxra Uloevq (HFN) (Ra,Wn,Se,Qr,Rf,Vg,Xb).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Ps3"));
            string outFolderName = $"Ps3_Grxxra_Uloevq_HFN_Ra_Wn_Se_Qr_Rf_Vg_Xb_7z_ExtractForensic_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Grxxra_Uloevq_HFN_Ra_Wn_Se_Qr_Rf_Vg_Xb_7z_ExtractForensic_Tests.txt"));
