...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Ps3_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Jr_Qner_Syvegl_Sha_sbe_Nyy_Rhebcr_Nhfgenyvn_Ra_Se_Qr_Rf_Vg_7z_Expand()
        {
            ...
            string outFolderName = $"Ps3_Jr_Qner_Syvegl_Sha_sbe_Nyy_Rhebcr_Nhfgenyvn_Ra_Se_Qr_Rf_Vg_7z_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Jr Qner - Syvegl Sha sbe Nyy (Rhebcr, Nhfgenyvn) (Ra,Se,Qr,Rf,Vg).iso", r.FinalName);
            ...
            Assert.Equal("Crc32:A7FF7E66", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Jr Qner - Syvegl Sha sbe Nyy (Rhebcr, Nhfgenyvn) (Ra,Se,Qr,Rf,Vg).iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Jr Qner - Syvegl Sha sbe Nyy (Rhebcr, Nhfgenyvn) (Ra,Se,Qr,Rf,Vg).iso", t.OutFileName);
            ...
            Assert.Equal("Crc32:A7FF7E66", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Jr Qner - Syvegl Sha sbe Nyy (Rhebcr, Nhfgenyvn) (Ra,Se,Qr,Rf,Vg).iso~", t.StepFiles[0].FileName);
