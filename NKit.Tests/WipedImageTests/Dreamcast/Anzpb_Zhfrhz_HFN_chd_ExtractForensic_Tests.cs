...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Anzpb_Zhfrhz_HFN_chd_ExtractForensic()
        {
            string fileName = @"Anzpb Zhfrhz (HFN).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Anzpb_Zhfrhz_HFN_chd_ExtractForensic_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Anzpb_Zhfrhz_HFN_chd_ExtractForensic_Tests.txt"));
