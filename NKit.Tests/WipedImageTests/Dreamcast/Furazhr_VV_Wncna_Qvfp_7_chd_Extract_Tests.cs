...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Furazhr_VV_Wncna_Qvfp_7_chd_Extract()
        {
            string fileName = @"Furazhr VV (Wncna) (Qvfp 7).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Furazhr_VV_Wncna_Qvfp_7_chd_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Furazhr_VV_Wncna_Qvfp_7_chd_Extract_Tests.txt"));
