...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Iveghn_Nguyrgr_7555_HFN_Ra_Se_Qr_Rf_chd_ConvertCue()
        {
            string fileName = @"Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Iveghn_Nguyrgr_7555_HFN_Ra_Se_Qr_Rf_chd_ConvertCue_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf) (Track 1).bin", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf) (Track 2).bin", r.OutFileParts[1].FileName);
            ...
            Assert.Equal("Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf) (Track 3).bin", r.OutFileParts[2].FileName);
            Assert.Equal(0x19bL, r.OutFileParts[3].Size);
            Assert.NotNull(r.OutFileParts[3].Checksums.ToString(true, true));
            Assert.Equal("Crc32:A7FF6036", r.OutFileParts[3].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[3].FileName);
            Assert.Equal("Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf).cue", r.OutFileParts[3].FileName);
            ...
            Assert.Equal("Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf) (Track 1).bin", t.StepFiles[0].FileName);
            ...
            Assert.Equal("Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf) (Track 2).bin", t.StepFiles[1].FileName);
            ...
            Assert.Equal("Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf) (Track 3).bin", t.StepFiles[2].FileName);
            Assert.Equal(0x19bL, t.StepFiles[3].Size);
            ...
            Assert.Equal("Crc32:A7FF6036", t.StepFiles[3].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[3].FileName);
            Assert.Equal("Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf).cue", t.StepFiles[3].FileName);
