...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zrzbevrf_Bss_7aq_Znxvat_Qvfp_Wncna_chd_ConvertCue()
        {
            string fileName = @"Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Zrzbevrf_Bss_7aq_Znxvat_Qvfp_Wncna_chd_ConvertCue_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna) (Track 1).bin", r.OutFileParts[0].FileName);
            Assert.Equal(0x1bc4410L, r.OutFileParts[1].Size);
            Assert.NotNull(r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.Equal("Crc32:B4B77D75", r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[1].FileName);
            Assert.Equal("Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna) (Track 2).bin", r.OutFileParts[1].FileName);
            ...
            Assert.Equal("Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna) (Track 3).bin", r.OutFileParts[2].FileName);
            ...
            Assert.Equal("Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna) (Track 4).bin", r.OutFileParts[3].FileName);
            Assert.Equal(0x32a3900L, r.OutFileParts[4].Size);
            Assert.NotNull(r.OutFileParts[4].Checksums.ToString(true, true));
            Assert.Equal("Crc32:AB2D2EBB", r.OutFileParts[4].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[4].FileName);
            Assert.Equal("Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna) (Track 5).bin", r.OutFileParts[4].FileName);
            Assert.Equal(0x2a0L, r.OutFileParts[5].Size);
            Assert.NotNull(r.OutFileParts[5].Checksums.ToString(true, true));
            Assert.Equal("Crc32:B12F7650", r.OutFileParts[5].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[5].FileName);
            Assert.Equal("Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna).cue", r.OutFileParts[5].FileName);
            ...
            Assert.Equal("Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna) (Track 1).bin", t.StepFiles[0].FileName);
            Assert.Equal(0x1bc4410L, t.StepFiles[1].Size);
            ...
            Assert.Equal("Crc32:B4B77D75", t.StepFiles[1].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[1].FileName);
            Assert.Equal("Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna) (Track 2).bin", t.StepFiles[1].FileName);
            ...
            Assert.Equal("Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna) (Track 3).bin", t.StepFiles[2].FileName);
            ...
            Assert.Equal("Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna) (Track 4).bin", t.StepFiles[3].FileName);
            Assert.Equal(0x32a3900L, t.StepFiles[4].Size);
            ...
            Assert.Equal("Crc32:AB2D2EBB", t.StepFiles[4].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[4].FileName);
            Assert.Equal("Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna) (Track 5).bin", t.StepFiles[4].FileName);
            Assert.Equal(0x2a0L, t.StepFiles[5].Size);
            ...
            Assert.Equal("Crc32:B12F7650", t.StepFiles[5].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[5].FileName);
            Assert.Equal("Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna).cue", t.StepFiles[5].FileName);
