...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Unat_gur_QW_Wncna_7z_Expand()
        {
            string fileName = @"Unat gur QW (Wncna).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Unat_gur_QW_Wncna_7z_Expand_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Crc32:8CE097BE", r.OutFileParts[4].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:8CE097BE", t.StepFiles[4].Checksums.ToString(true, true));
