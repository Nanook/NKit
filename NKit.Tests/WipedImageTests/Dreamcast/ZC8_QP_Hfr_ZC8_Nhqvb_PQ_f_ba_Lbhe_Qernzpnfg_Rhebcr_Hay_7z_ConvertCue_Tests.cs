...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void ZC8_QP_Hfr_ZC8_Nhqvb_PQ_f_ba_Lbhe_Qernzpnfg_Rhebcr_Hay_7z_ConvertCue()
        {
            ...
            string outFolderName = $"Dreamcast_ZC8_QP_Hfr_ZC8_Nhqvb_PQ_f_ba_Lbhe_Qernzpnfg_Rhebcr_Hay_7z_ConvertCue_{Guid.NewGuid():N}";
