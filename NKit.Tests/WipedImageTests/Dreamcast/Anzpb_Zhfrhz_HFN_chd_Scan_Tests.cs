...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Anzpb_Zhfrhz_HFN_chd_Scan()
        {
            string fileName = @"Anzpb Zhfrhz (HFN).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Anzpb_Zhfrhz_HFN_chd_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Anzpb Zhfrhz (HFN).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Sha1:0802CD5310EE1C8095A26DB77001AC57F7E2B016", r.InFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("Anzpb Zhfrhz (HFN)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("0802CD5310EE1C8095A26DB77001AC57F7E2B016", t.VerifyChecksum);
            ...
            Assert.Equal("Anzpb Zhfrhz (HFN)", t.StepFiles[0].FileName);
