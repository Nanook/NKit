...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Iveghn_Nguyrgr_7555_HFN_Ra_Se_Qr_Rf_chd_Scan()
        {
            string fileName = @"Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Iveghn_Nguyrgr_7555_HFN_Ra_Se_Qr_Rf_chd_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Sha1:6F5599972028B1B030838A800DA5022A8D17191D", r.InFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("6F5599972028B1B030838A800DA5022A8D17191D", t.VerifyChecksum);
            ...
            Assert.Equal("Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf)", t.StepFiles[0].FileName);
