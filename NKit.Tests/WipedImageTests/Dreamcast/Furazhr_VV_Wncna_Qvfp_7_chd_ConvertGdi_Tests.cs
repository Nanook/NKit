...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Furazhr_VV_Wncna_Qvfp_7_chd_ConvertGdi()
        {
            string fileName = @"Furazhr VV (Wncna) (Qvfp 7).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Furazhr_VV_Wncna_Qvfp_7_chd_ConvertGdi_{Guid.NewGuid():N}";
            ...
            Assert.Equal(0x170130L, r.OutFileParts[1].Size);
            Assert.NotNull(r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.Equal("Crc32:76BC8F0B", r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[1].FileName);
            Assert.Equal("track02.raw", r.OutFileParts[1].FileName);
            Assert.Equal(0x1c2f0f0L, r.OutFileParts[2].Size);
            Assert.NotNull(r.OutFileParts[2].Checksums.ToString(true, true));
            Assert.Equal("Crc32:E08387BB", r.OutFileParts[2].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[2].FileName);
            Assert.Equal("track03.bin", r.OutFileParts[2].FileName);
            Assert.Equal(0x44ea5530L, r.OutFileParts[3].Size);
            Assert.NotNull(r.OutFileParts[3].Checksums.ToString(true, true));
            Assert.Equal("Crc32:DCCDC996", r.OutFileParts[3].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[3].FileName);
            Assert.Equal("track04.bin", r.OutFileParts[3].FileName);
            Assert.Equal(0x75L, r.OutFileParts[4].Size);
            Assert.NotNull(r.OutFileParts[4].Checksums.ToString(true, true));
            Assert.Equal("Crc32:8DD7A9D8", r.OutFileParts[4].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[4].FileName);
            Assert.Equal("Furazhr VV (Wncna) (Qvfp 7).gdi", r.OutFileParts[4].FileName);
            ...
            Assert.Equal(0x170130L, t.StepFiles[1].Size);
            ...
            Assert.Equal("Crc32:76BC8F0B", t.StepFiles[1].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[1].FileName);
            Assert.Equal("track02.raw", t.StepFiles[1].FileName);
            Assert.Equal(0x1c2f0f0L, t.StepFiles[2].Size);
            ...
            Assert.Equal("Crc32:E08387BB", t.StepFiles[2].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[2].FileName);
            Assert.Equal("track03.bin", t.StepFiles[2].FileName);
            Assert.Equal(0x44ea5530L, t.StepFiles[3].Size);
            ...
            Assert.Equal("Crc32:DCCDC996", t.StepFiles[3].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[3].FileName);
            Assert.Equal("track04.bin", t.StepFiles[3].FileName);
            Assert.Equal(0x75L, t.StepFiles[4].Size);
            ...
            Assert.Equal("Crc32:8DD7A9D8", t.StepFiles[4].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[4].FileName);
            Assert.Equal("Furazhr VV (Wncna) (Qvfp 7).gdi", t.StepFiles[4].FileName);
