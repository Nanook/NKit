...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Unat_gur_QW_Wncna_chd_Expand()
        {
            string fileName = @"Unat gur QW (Wncna).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Unat_gur_QW_Wncna_chd_Expand_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Unat gur QW (Wncna) (Track 1).raw", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Unat gur QW (Wncna) (Track 2).raw", r.OutFileParts[1].FileName);
            ...
            Assert.Equal("Unat gur QW (Wncna) (Track 3).raw", r.OutFileParts[2].FileName);
            ...
            Assert.Equal("Crc32:D8EDE9AD", r.OutFileParts[4].Checksums.ToString(true, true));
            ...
            Assert.Equal("Unat gur QW (Wncna) (Track 1).raw", t.StepFiles[0].FileName);
            ...
            Assert.Equal("Unat gur QW (Wncna) (Track 2).raw", t.StepFiles[1].FileName);
            ...
            Assert.Equal("Unat gur QW (Wncna) (Track 3).raw", t.StepFiles[2].FileName);
            ...
            Assert.Equal("Crc32:D8EDE9AD", t.StepFiles[4].Checksums.ToString(true, true));
