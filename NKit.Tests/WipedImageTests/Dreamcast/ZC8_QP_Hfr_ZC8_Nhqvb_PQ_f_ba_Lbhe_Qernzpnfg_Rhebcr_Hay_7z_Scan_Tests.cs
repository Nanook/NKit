...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void ZC8_QP_Hfr_ZC8_Nhqvb_PQ_f_ba_Lbhe_Qernzpnfg_Rhebcr_Hay_7z_Scan()
        {
            ...
            string outFolderName = $"Dreamcast_ZC8_QP_Hfr_ZC8_Nhqvb_PQ_f_ba_Lbhe_Qernzpnfg_Rhebcr_Hay_7z_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("ZC8 QP - Hfr ZC8 Nhqvb PQ'f ba Lbhe Qernzpnfg (Rhebcr) (Hay).nkit.yaml", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x2a7648b0L, r.OutFileParts[0].Size);
            ...
            Assert.Equal("ZC8 QP - Hfr ZC8 Nhqvb PQ'f ba Lbhe Qernzpnfg (Rhebcr) (Hay)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal(0x2a7648b0L, t.StepFiles[0].Size);
            ...
            Assert.Equal("ZC8 QP - Hfr ZC8 Nhqvb PQ'f ba Lbhe Qernzpnfg (Rhebcr) (Hay)", t.StepFiles[0].FileName);
