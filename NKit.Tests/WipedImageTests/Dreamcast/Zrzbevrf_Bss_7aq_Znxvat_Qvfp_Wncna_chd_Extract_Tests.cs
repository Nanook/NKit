...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zrzbevrf_Bss_7aq_Znxvat_Qvfp_Wncna_chd_Extract()
        {
            string fileName = @"Zrzbevrf Bss 7aq - Znxvat Qvfp (Wncna).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Zrzbevrf_Bss_7aq_Znxvat_Qvfp_Wncna_chd_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Zrzbevrf_Bss_7aq_Znxvat_Qvfp_Wncna_chd_Extract_Tests.txt"));
