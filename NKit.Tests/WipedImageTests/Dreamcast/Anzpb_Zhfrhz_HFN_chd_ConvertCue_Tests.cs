...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Anzpb_Zhfrhz_HFN_chd_ConvertCue()
        {
            string fileName = @"Anzpb Zhfrhz (HFN).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Anzpb_Zhfrhz_HFN_chd_ConvertCue_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Anzpb Zhfrhz (HFN) (Track 1).bin", r.OutFileParts[0].FileName);
            Assert.Equal(0x1842c0L, r.OutFileParts[1].Size);
            Assert.NotNull(r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.Equal("Crc32:12CE2BAB", r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[1].FileName);
            Assert.Equal("Anzpb Zhfrhz (HFN) (Track 2).bin", r.OutFileParts[1].FileName);
            ...
            Assert.Equal("Anzpb Zhfrhz (HFN) (Track 3).bin", r.OutFileParts[2].FileName);
            Assert.Equal(0x12e0a0L, r.OutFileParts[3].Size);
            Assert.NotNull(r.OutFileParts[3].Checksums.ToString(true, true));
            Assert.Equal("Crc32:0ECFB684", r.OutFileParts[3].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[3].FileName);
            Assert.Equal("Anzpb Zhfrhz (HFN) (Track 4).bin", r.OutFileParts[3].FileName);
            Assert.Equal(0x703950L, r.OutFileParts[4].Size);
            Assert.NotNull(r.OutFileParts[4].Checksums.ToString(true, true));
            Assert.Equal("Crc32:95EA1D5E", r.OutFileParts[4].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[4].FileName);
            Assert.Equal("Anzpb Zhfrhz (HFN) (Track 5).bin", r.OutFileParts[4].FileName);
            Assert.Equal(0x241L, r.OutFileParts[5].Size);
            Assert.NotNull(r.OutFileParts[5].Checksums.ToString(true, true));
            Assert.Equal("Crc32:B6AEE860", r.OutFileParts[5].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[5].FileName);
            Assert.Equal("Anzpb Zhfrhz (HFN).cue", r.OutFileParts[5].FileName);
            ...
            Assert.Equal("Anzpb Zhfrhz (HFN) (Track 1).bin", t.StepFiles[0].FileName);
            Assert.Equal(0x1842c0L, t.StepFiles[1].Size);
            ...
            Assert.Equal("Crc32:12CE2BAB", t.StepFiles[1].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[1].FileName);
            Assert.Equal("Anzpb Zhfrhz (HFN) (Track 2).bin", t.StepFiles[1].FileName);
            ...
            Assert.Equal("Anzpb Zhfrhz (HFN) (Track 3).bin", t.StepFiles[2].FileName);
            Assert.Equal(0x12e0a0L, t.StepFiles[3].Size);
            ...
            Assert.Equal("Crc32:0ECFB684", t.StepFiles[3].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[3].FileName);
            Assert.Equal("Anzpb Zhfrhz (HFN) (Track 4).bin", t.StepFiles[3].FileName);
            Assert.Equal(0x703950L, t.StepFiles[4].Size);
            ...
            Assert.Equal("Crc32:95EA1D5E", t.StepFiles[4].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[4].FileName);
            Assert.Equal("Anzpb Zhfrhz (HFN) (Track 5).bin", t.StepFiles[4].FileName);
            Assert.Equal(0x241L, t.StepFiles[5].Size);
            ...
            Assert.Equal("Crc32:B6AEE860", t.StepFiles[5].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[5].FileName);
            Assert.Equal("Anzpb Zhfrhz (HFN).cue", t.StepFiles[5].FileName);
