...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Furazhr_VV_Wncna_Qvfp_7_chd_Scan()
        {
            string fileName = @"Furazhr VV (Wncna) (Qvfp 7).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Furazhr_VV_Wncna_Qvfp_7_chd_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Furazhr VV (Wncna) (Qvfp 7).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Sha1:C4AF8F30F108C406559D2E3728740BC4A8A56872", r.InFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("Furazhr VV (Wncna) (Qvfp 7)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("C4AF8F30F108C406559D2E3728740BC4A8A56872", t.VerifyChecksum);
            ...
            Assert.Equal("Furazhr VV (Wncna) (Qvfp 7)", t.StepFiles[0].FileName);
