...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Anzpb_Zhfrhz_i6_565_7555_Anzpb_HF_7F_pbzcvyngvba_7z_ConvertCue()
        {
            ...
            string outFolderName = $"Dreamcast_Anzpb_Zhfrhz_i6_565_7555_Anzpb_HF_7F_pbzcvyngvba_7z_ConvertCue_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba] (Track 1).bin", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba] (Track 2).bin", r.OutFileParts[1].FileName);
            ...
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba] (Track 3).bin", r.OutFileParts[2].FileName);
            ...
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba] (Track 4).bin", r.OutFileParts[3].FileName);
            Assert.Equal(0x682620L, r.OutFileParts[4].Size);
            Assert.NotNull(r.OutFileParts[4].Checksums.ToString(true, true));
            Assert.Equal("Crc32:3771921E", r.OutFileParts[4].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[4].FileName);
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba] (Track 5).bin", r.OutFileParts[4].FileName);
            Assert.Equal(0x304L, r.OutFileParts[5].Size);
            Assert.NotNull(r.OutFileParts[5].Checksums.ToString(true, true));
            Assert.Equal("Crc32:C67C5063", r.OutFileParts[5].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[5].FileName);
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba].cue", r.OutFileParts[5].FileName);
            ...
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba] (Track 1).bin", t.StepFiles[0].FileName);
            ...
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba] (Track 2).bin", t.StepFiles[1].FileName);
            ...
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba] (Track 3).bin", t.StepFiles[2].FileName);
            ...
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba] (Track 4).bin", t.StepFiles[3].FileName);
            ...
            Assert.Equal("Crc32:3771921E", t.StepFiles[4].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[4].FileName);
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba] (Track 5).bin", t.StepFiles[4].FileName);
            Assert.Equal(0x304L, t.StepFiles[5].Size);
            ...
            Assert.Equal("Crc32:C67C5063", t.StepFiles[5].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[5].FileName);
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba].cue", t.StepFiles[5].FileName);
