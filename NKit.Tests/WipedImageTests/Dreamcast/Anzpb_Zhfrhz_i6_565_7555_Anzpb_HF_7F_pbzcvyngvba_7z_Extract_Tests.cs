...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Anzpb_Zhfrhz_i6_565_7555_Anzpb_HF_7F_pbzcvyngvba_7z_Extract()
        {
            ...
            string outFolderName = $"Dreamcast_Anzpb_Zhfrhz_i6_565_7555_Anzpb_HF_7F_pbzcvyngvba_7z_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Anzpb_Zhfrhz_i6_565_7555_Anzpb_HF_7F_pbzcvyngvba_7z_Extract_Tests.txt"));
