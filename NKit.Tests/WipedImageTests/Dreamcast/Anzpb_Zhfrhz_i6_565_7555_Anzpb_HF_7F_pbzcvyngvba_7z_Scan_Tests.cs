...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Anzpb_Zhfrhz_i6_565_7555_Anzpb_HF_7F_pbzcvyngvba_7z_Scan()
        {
            ...
            string outFolderName = $"Dreamcast_Anzpb_Zhfrhz_i6_565_7555_Anzpb_HF_7F_pbzcvyngvba_7z_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba].nkit.yaml", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x46cb2220L, r.OutFileParts[0].Size);
            ...
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba]", r.OutFileParts[0].FileName);
            ...
            Assert.Equal(0x46cb2220L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Anzpb Zhfrhz i6.565 (7555)(Anzpb)(HF)[!][7F][pbzcvyngvba]", t.StepFiles[0].FileName);
