...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Dreamcast_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Iveghn_Nguyrgr_7555_HFN_Ra_Se_Qr_Rf_chd_Extract()
        {
            string fileName = @"Iveghn Nguyrgr 7555 (HFN) (Ra,Se,Qr,Rf).chd";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Dreamcast"));
            string outFolderName = $"Dreamcast_Iveghn_Nguyrgr_7555_HFN_Ra_Se_Qr_Rf_chd_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Iveghn_Nguyrgr_7555_HFN_Ra_Se_Qr_Rf_chd_Extract_Tests.txt"));
