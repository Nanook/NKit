...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Cdi_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void PQ_V_Zhfvp_Obbx_Pynffvpny_Thvgne_Ibyhzr_6_HFN_7z_Expand()
        {
            ...
            string outFolderName = $"Cdi_PQ_V_Zhfvp_Obbx_Pynffvpny_Thvgne_Ibyhzr_6_HFN_7z_Expand_{Guid.NewGuid():N}";
