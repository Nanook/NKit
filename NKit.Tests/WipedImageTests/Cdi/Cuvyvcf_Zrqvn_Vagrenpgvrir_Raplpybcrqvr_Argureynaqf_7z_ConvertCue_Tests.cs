...
namespace NKit.Tests.Full.Wiped
{
    ...
    {
        //Retail     / CUE       / 742MiB  / CD-i Fs
        [Fact]
        public void Cuvyvcf_Zrqvn_Vagrenpgvrir_Raplpybcrqvr_Argureynaqf_7z_ConvertCue()
        {
            string fileName = @"Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Cdi"));
            string outFolderName = $"Cdi_Cuvyvcf_Zrqvn_Vagrenpgvrir_Raplpybcrqvr_Argureynaqf_7z_ConvertCue_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).7z//Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).cue", f.FriendlyFullPath.Replace(f.BasePath, ""));
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf)", f.CleanName);
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf)", f.Name);
            ...
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).bin", f.ImageFiles[0].FileName);
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf)", f.ImageFiles[0].NameOnly);
            Assert.Equal(".bin", f.ImageFiles[0].Extension);
            Assert.Equal(0x2e6640d0L, f.ImageFiles[0].Size);
            ...
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).7z", f.ArchiveFiles[0].FileName);
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf)", f.ArchiveFiles[0].NameOnly);
            Assert.Equal(".7z", f.ArchiveFiles[0].Extension);
            Assert.Equal(0x40993eL, f.ArchiveFiles[0].Size);
            Assert.False(f.ArchiveFiles[0].IsArchived);
            Assert.Null(f.Key);
            // f.IndexFile IndexFile Test
            Assert.NotNull(f.IndexFile);
            Assert.Equal(0xb8d8612bU, f.IndexFile.Crc);
            ...
            Assert.Equal(0x8cL, f.IndexFile.Size);
            ...
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).cue", f.IndexFile.FileName);
            Assert.NotNull(f.IndexFile.NameOnly);
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf)", f.IndexFile.NameOnly);
            ...
            Assert.Equal(330975, f.IndexFile.Items[0].Blocks);
            ...
            Assert.Equal(0x2e6640d0L, f.IndexFile.Items[0].Size);
            ...
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).bin", f.IndexFile.Items[0].FileName);
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf)", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(2, r.OutFileParts.Length);
            Assert.Equal(0x2e6640d0L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:28418521", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).bin", r.OutFileParts[0].FileName);
            Assert.Equal(0x77L, r.OutFileParts[1].Size);
            Assert.NotNull(r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.Equal("Crc32:0C7608FC", r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[1].FileName);
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).cue", r.OutFileParts[1].FileName);
            Assert.NotNull(r.ResultCrc);
            Assert.Equal(0x28418521U, r.ResultCrc.Value);
            Assert.NotNull(r.ResultSize);
            Assert.Equal(0x2e6640d0L, r.ResultSize.Value);
            ...
            Assert.Equal(0x2e6640d0L, t.Size);
            Assert.Equal(0x28418521U, t.CRC);
            ...
            Assert.Equal(Path.Combine(basePath, "Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf)"), t.OutPath);
            Assert.NotNull(t.Name);
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf)", t.Name);
            ...
            Assert.Equal(Path.Combine(basePath, "Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).nkit.yaml"), t.OutScanFilePath);
            ...
            Assert.Equal(0x2e6640d0L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:28418521", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).bin", t.StepFiles[0].FileName);
            Assert.Equal(0x77L, t.StepFiles[1].Size);
            ...
            Assert.Equal("Crc32:0C7608FC", t.StepFiles[1].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[1].FileName);
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).cue", t.StepFiles[1].FileName);
            ...
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf)", t.Scan.Name);
            Assert.Equal(SystemType.CDi, f.SystemType);
            Assert.Equal(0x28418521U, t.Scan.Crc);
            Assert.Equal(0x28418521U, t.Scan.CrcDecrypted);
            Assert.Equal(0x2e6640d0L, t.Scan.Size);
            ...
            Assert.Equal("02E6640D0", t.Scan.Properties["Size"].ToXmlValue());
            Assert.NotNull(t.Scan.Properties["CRC"].ToXmlValue());
            Assert.Equal("28418521", t.Scan.Properties["CRC"].ToXmlValue());
            ...
            Assert.Equal("61104", t.Scan.Areas[0].AreaInfo.Properties["Mode2Form1"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["Mode2Form2"].ToXmlValue());
            Assert.Equal("269870", t.Scan.Areas[0].AreaInfo.Properties["Mode2Form2"].ToXmlValue());
            ...
            Assert.Equal("000050CDF", t.Scan.Areas[0].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            ...
            Assert.Equal(0x28418521U, t.Scan.Areas[0].Crc);
            Assert.Equal(0x28418521U, t.Scan.Areas[0].CrcDecrypted);
            Assert.Equal(0x2e6640d0L, t.Scan.Areas[0].Size);
            ...
            Assert.Equal(11, t_ScanTypes0[FsType.Cdi]);
