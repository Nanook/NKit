...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Cdi_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Cuvyvcf_Zrqvn_Vagrenpgvrir_Raplpybcrqvr_Argureynaqf_7z_Expand()
        {
            ...
            string outFolderName = $"Cdi_Cuvyvcf_Zrqvn_Vagrenpgvrir_Raplpybcrqvr_Argureynaqf_7z_Expand_{Guid.NewGuid():N}";
