...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Cdi_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Hygen_PQ_v_Fbppre_Rhebcr_7z_Scan()
        {
            string fileName = @"Hygen PQ-v Fbppre (Rhebcr).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Cdi"));
            string outFolderName = $"Cdi_Hygen_PQ_v_Fbppre_Rhebcr_7z_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Hygen PQ-v Fbppre (Rhebcr).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Hygen PQ-v Fbppre (Rhebcr)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Hygen PQ-v Fbppre (Rhebcr)", t.StepFiles[0].FileName);
