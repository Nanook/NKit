...
namespace NKit.Tests.Full.Wiped
{
    ...
    {
        //Retail     / CUE       / 118MiB  / CD-i Fs
        [Fact]
        public void PQ_V_Zhfvp_Obbx_Pynffvpny_Thvgne_Ibyhzr_6_HFN_7z_ConvertCue()
        {
            string fileName = @"PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Cdi"));
            string outFolderName = $"Cdi_PQ_V_Zhfvp_Obbx_Pynffvpny_Thvgne_Ibyhzr_6_HFN_7z_ConvertCue_{Guid.NewGuid():N}";
            ...
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).7z//PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).cue", f.FriendlyFullPath.Replace(f.BasePath, ""));
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN)", f.CleanName);
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN)", f.Name);
            ...
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).bin", f.ImageFiles[0].FileName);
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN)", f.ImageFiles[0].NameOnly);
            Assert.Equal(".bin", f.ImageFiles[0].Extension);
            Assert.Equal(0x75ab840L, f.ImageFiles[0].Size);
            ...
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).7z", f.ArchiveFiles[0].FileName);
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN)", f.ArchiveFiles[0].NameOnly);
            Assert.Equal(".7z", f.ArchiveFiles[0].Extension);
            Assert.Equal(0x451bbbL, f.ArchiveFiles[0].Size);
            Assert.False(f.ArchiveFiles[0].IsArchived);
            Assert.Null(f.Key);
            // f.IndexFile IndexFile Test
            Assert.NotNull(f.IndexFile);
            Assert.Equal(0x2f4ebcf2U, f.IndexFile.Crc);
            ...
            Assert.Equal(0x88L, f.IndexFile.Size);
            ...
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).cue", f.IndexFile.FileName);
            Assert.NotNull(f.IndexFile.NameOnly);
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN)", f.IndexFile.NameOnly);
            ...
            Assert.Equal(52460, f.IndexFile.Items[0].Blocks);
            ...
            Assert.Equal(0x75ab840L, f.IndexFile.Items[0].Size);
            ...
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).bin", f.IndexFile.Items[0].FileName);
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN)", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(2, r.OutFileParts.Length);
            Assert.Equal(0x75ab840L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:65F55AB9", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).bin", r.OutFileParts[0].FileName);
            Assert.Equal(0x73L, r.OutFileParts[1].Size);
            Assert.NotNull(r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.Equal("Crc32:02D7B386", r.OutFileParts[1].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[1].FileName);
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).cue", r.OutFileParts[1].FileName);
            Assert.NotNull(r.ResultCrc);
            Assert.Equal(0x65f55ab9U, r.ResultCrc.Value);
            Assert.NotNull(r.ResultSize);
            Assert.Equal(0x75ab840L, r.ResultSize.Value);
            ...
            Assert.Equal(0x75ab840L, t.Size);
            Assert.Equal(0x65f55ab9U, t.CRC);
            ...
            Assert.Equal(Path.Combine(basePath, "PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN)"), t.OutPath);
            Assert.NotNull(t.Name);
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN)", t.Name);
            ...
            Assert.Equal(Path.Combine(basePath, "PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).nkit.yaml"), t.OutScanFilePath);
            ...
            Assert.Equal(0x75ab840L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:65F55AB9", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).bin", t.StepFiles[0].FileName);
            Assert.Equal(0x73L, t.StepFiles[1].Size);
            ...
            Assert.Equal("Crc32:02D7B386", t.StepFiles[1].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[1].FileName);
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).cue", t.StepFiles[1].FileName);
            ...
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN)", t.Scan.Name);
            Assert.Equal(SystemType.CDi, f.SystemType);
            Assert.Equal(0x65f55ab9U, t.Scan.Crc);
            Assert.Equal(0x65f55ab9U, t.Scan.CrcDecrypted);
            Assert.Equal(0x75ab840L, t.Scan.Size);
            ...
            Assert.Equal("0075AB840", t.Scan.Properties["Size"].ToXmlValue());
            Assert.NotNull(t.Scan.Properties["CRC"].ToXmlValue());
            Assert.Equal("65F55AB9", t.Scan.Properties["CRC"].ToXmlValue());
            ...
            Assert.Equal("2152", t.Scan.Areas[0].AreaInfo.Properties["Mode2Form1"].ToXmlValue());
            Assert.NotNull(t.Scan.Areas[0].AreaInfo.Properties["Mode2Form2"].ToXmlValue());
            Assert.Equal("50307", t.Scan.Areas[0].AreaInfo.Properties["Mode2Form2"].ToXmlValue());
            ...
            Assert.Equal("00000CC4C", t.Scan.Areas[0].AreaInfo.Properties["PvdSectorCount"].ToXmlValue());
            ...
            Assert.Equal(0x65f55ab9U, t.Scan.Areas[0].Crc);
            Assert.Equal(0x65f55ab9U, t.Scan.Areas[0].CrcDecrypted);
            Assert.Equal(0x75ab840L, t.Scan.Areas[0].Size);
            ...
            Assert.Equal(17, t_ScanTypes0[FsType.Cdi]);
