...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Cdi_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Cuvyvcf_Zrqvn_Vagrenpgvrir_Raplpybcrqvr_Argureynaqf_7z_Scan()
        {
            ...
            string outFolderName = $"Cdi_Cuvyvcf_Zrqvn_Vagrenpgvrir_Raplpybcrqvr_Argureynaqf_7z_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Cuvyvcf Zrqvn Vagrenpgvrir Raplpybcrqvr (Argureynaqf)", t.StepFiles[0].FileName);
