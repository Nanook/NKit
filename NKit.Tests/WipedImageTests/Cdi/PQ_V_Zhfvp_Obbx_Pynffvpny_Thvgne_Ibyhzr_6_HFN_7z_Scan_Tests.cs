...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Cdi_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void PQ_V_Zhfvp_Obbx_Pynffvpny_Thvgne_Ibyhzr_6_HFN_7z_Scan()
        {
            ...
            string outFolderName = $"Cdi_PQ_V_Zhfvp_Obbx_Pynffvpny_Thvgne_Ibyhzr_6_HFN_7z_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN).nkit.yaml", r.FinalName);
            ...
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("PQ-V Zhfvp Obbx - Pynffvpny Thvgne Ibyhzr 6 (HFN)", t.StepFiles[0].FileName);
