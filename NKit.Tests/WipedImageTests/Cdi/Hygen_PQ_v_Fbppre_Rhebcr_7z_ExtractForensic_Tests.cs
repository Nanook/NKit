...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Cdi_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Hygen_PQ_v_Fbppre_Rhebcr_7z_ExtractForensic()
        {
            string fileName = @"Hygen PQ-v Fbppre (Rhebcr).7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Cdi"));
            string outFolderName = $"Cdi_Hygen_PQ_v_Fbppre_Rhebcr_7z_ExtractForensic_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Hygen_PQ_v_Fbppre_Rhebcr_7z_ExtractForensic_Tests.txt"));
