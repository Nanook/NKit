...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Cdi_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Cuvyvcf_Zrqvn_Vagrenpgvrir_Raplpybcrqvr_Argureynaqf_7z_Extract()
        {
            ...
            string outFolderName = $"Cdi_Cuvyvcf_Zrqvn_Vagrenpgvrir_Raplpybcrqvr_Argureynaqf_7z_Extract_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Cuvyvcf_Zrqvn_Vagrenpgvrir_Raplpybcrqvr_Argureynaqf_7z_Extract_Tests.txt"));
