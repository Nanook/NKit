...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Cdi_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void PQ_V_Zhfvp_Obbx_Pynffvpny_Thvgne_Ibyhzr_6_HFN_7z_ExtractForensic()
        {
            ...
            string outFolderName = $"Cdi_PQ_V_Zhfvp_Obbx_Pynffvpny_Thvgne_Ibyhzr_6_HFN_7z_ExtractForensic_{Guid.NewGuid():N}";
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "PQ_V_Zhfvp_Obbx_Pynffvpny_Thvgne_Ibyhzr_6_HFN_7z_ExtractForensic_Tests.txt"));
