...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvkryf_IPQ_qhzc_7z_Expand()
        {
            string fileName = @"Zvkryf IPQ qhzc.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Zvkryf_IPQ_qhzc_7z_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Zvkryf IPQ qhzc.iso", r.FinalName);
            ...
            Assert.Equal("Crc32:64168195", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Zvkryf IPQ qhzc.iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Zvkryf IPQ qhzc.iso", t.OutFileName);
            ...
            Assert.Equal("Crc32:64168195", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Zvkryf IPQ qhzc.iso~", t.StepFiles[0].FileName);
