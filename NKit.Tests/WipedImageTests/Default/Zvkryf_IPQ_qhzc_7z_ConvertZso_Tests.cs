...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvkryf_IPQ_qhzc_7z_ConvertZso()
        {
            string fileName = @"Zvkryf IPQ qhzc.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Zvkryf_IPQ_qhzc_7z_ConvertZso_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Zvkryf IPQ qhzc.zso", r.FinalName);
            ...
            Assert.Equal(0x2d1ceaL, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:EACC9121", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Zvkryf IPQ qhzc.zso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Zvkryf IPQ qhzc.zso", t.OutFileName);
            ...
            Assert.Equal(0x2d1ceaL, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:EACC9121", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Zvkryf IPQ qhzc.zso~", t.StepFiles[0].FileName);
