...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvpebfbsg_Choyvfure_7555_7z_ConvertCso()
        {
            string fileName = @"Zvpebfbsg Choyvfure 7555.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Zvpebfbsg_Choyvfure_7555_7z_ConvertCso_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Crc32:1B7942D9", r.OutFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:1B7942D9", t.StepFiles[0].Checksums.ToString(true, true));
