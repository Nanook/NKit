...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvpebfbsg_Choyvfure_7555_7z_ExtractForensic()
        {
            string fileName = @"Zvpebfbsg Choyvfure 7555.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Zvpebfbsg_Choyvfure_7555_7z_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Zvpebfbsg Choyvfure 7555", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Zvpebfbsg Choyvfure 7555"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Zvpebfbsg_Choyvfure_7555_7z_ExtractForensic_Tests.txt"));
