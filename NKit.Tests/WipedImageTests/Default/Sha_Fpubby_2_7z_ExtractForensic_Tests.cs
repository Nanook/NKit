...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Sha_Fpubby_2_7z_ExtractForensic()
        {
            string fileName = @"Sha Fpubby 2.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Sha_Fpubby_2_7z_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Sha Fpubby 2", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Sha Fpubby 2"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Sha_Fpubby_2_7z_ExtractForensic_Tests.txt"));
