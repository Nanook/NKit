...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvkryf_IPQ_qhzc_7z_Scan()
        {
            string fileName = @"Zvkryf IPQ qhzc.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Zvkryf_IPQ_qhzc_7z_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Zvkryf IPQ qhzc.nkit.yaml", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0xdded800L, r.OutFileParts[0].Size);
            ...
            Assert.Equal("Zvkryf IPQ qhzc", r.OutFileParts[0].FileName);
            ...
            Assert.Equal(0xdded800L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Zvkryf IPQ qhzc", t.StepFiles[0].FileName);
