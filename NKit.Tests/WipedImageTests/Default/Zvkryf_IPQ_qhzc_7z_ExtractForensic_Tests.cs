...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvkryf_IPQ_qhzc_7z_ExtractForensic()
        {
            string fileName = @"Zvkryf IPQ qhzc.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Zvkryf_IPQ_qhzc_7z_ExtractForensic_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Zvkryf IPQ qhzc", r.FinalName);
            ...
            Assert.Equal(Path.Combine(basePath, "Zvkryf IPQ qhzc"), t.OutPath);
            ...
            string[] extractLines = File.ReadAllLines(Path.Combine(base.GetPath(), "Zvkryf_IPQ_qhzc_7z_ExtractForensic_Tests.txt"));
