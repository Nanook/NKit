...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Sha_Fpubby_2_7z_Expand()
        {
            string fileName = @"Sha Fpubby 2.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Sha_Fpubby_2_7z_Expand_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Sha Fpubby 2.iso", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x61c4800L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:40564B27", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Sha Fpubby 2.iso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Sha Fpubby 2.iso", t.OutFileName);
            ...
            Assert.Equal(0x61c4800L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:40564B27", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Sha Fpubby 2.iso~", t.StepFiles[0].FileName);
