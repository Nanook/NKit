...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvpebfbsg_Choyvfure_7555_7z_ConvertZso()
        {
            string fileName = @"Zvpebfbsg Choyvfure 7555.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Zvpebfbsg_Choyvfure_7555_7z_ConvertZso_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Zvpebfbsg Choyvfure 7555.zso", r.FinalName);
            ...
            Assert.Equal(0x702794L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:3F03B7F5", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Zvpebfbsg Choyvfure 7555.zso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Zvpebfbsg Choyvfure 7555.zso", t.OutFileName);
            ...
            Assert.Equal(0x702794L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:3F03B7F5", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Zvpebfbsg Choyvfure 7555.zso~", t.StepFiles[0].FileName);
