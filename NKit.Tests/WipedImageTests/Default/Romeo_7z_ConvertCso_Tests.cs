...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Romeo_7z_ConvertCso()
        {
            string fileName = @"Romeo.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Romeo_7z_ConvertCso_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Crc32:77173C4C", r.OutFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:77173C4C", t.StepFiles[0].Checksums.ToString(true, true));
