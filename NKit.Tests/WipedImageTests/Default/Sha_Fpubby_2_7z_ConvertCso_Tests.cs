...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Sha_Fpubby_2_7z_ConvertCso()
        {
            string fileName = @"Sha Fpubby 2.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Sha_Fpubby_2_7z_ConvertCso_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Crc32:5BB9161B", r.OutFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:5BB9161B", t.StepFiles[0].Checksums.ToString(true, true));
