...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Sha_Fpubby_2_7z_ConvertCso2()
        {
            string fileName = @"Sha Fpubby 2.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Sha_Fpubby_2_7z_ConvertCso2_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Sha Fpubby 2.cso", r.FinalName);
            ...
            Assert.Equal(0x13b660L, r.OutFileParts[0].Size);
            Assert.NotNull(r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.Equal("Crc32:1CE6C79C", r.OutFileParts[0].Checksums.ToString(true, true));
            Assert.NotNull(r.OutFileParts[0].FileName);
            Assert.Equal("Sha Fpubby 2.cso~", r.OutFileParts[0].FileName);
            ...
            Assert.Equal("Sha Fpubby 2.cso", t.OutFileName);
            ...
            Assert.Equal(0x13b660L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Crc32:1CE6C79C", t.StepFiles[0].Checksums.ToString(true, true));
            Assert.NotNull(t.StepFiles[0].FileName);
            Assert.Equal("Sha Fpubby 2.cso~", t.StepFiles[0].FileName);
