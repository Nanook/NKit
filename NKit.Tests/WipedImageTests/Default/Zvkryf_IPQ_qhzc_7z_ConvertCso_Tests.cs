...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Zvkryf_IPQ_qhzc_7z_ConvertCso()
        {
            string fileName = @"Zvkryf IPQ qhzc.7z";
            string inPath = Path.GetFullPath(Path.Combine(@"../../../../../WipedImages", "Default"));
            string outFolderName = $"Default_Zvkryf_IPQ_qhzc_7z_ConvertCso_{Guid.NewGuid():N}";
            ...
            Assert.Equal("Crc32:95D71CAF", r.OutFileParts[0].Checksums.ToString(true, true));
            ...
            Assert.Equal("Crc32:95D71CAF", t.StepFiles[0].Checksums.ToString(true, true));
