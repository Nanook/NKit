...
namespace NKit.Tests.Full.Wiped
{
    public partial class WipedImage_Default_Tests : WipedImageTestsBase
    {
        ...
        [Fact]
        public void Abk_Rhebcr_Ra_Se_Qr_Rf_Vg_Qvfp_8_Znahnyf_Qvfp_Ereryrnfr_7z_Scan()
        {
            ...
            string outFolderName = $"Default_Abk_Rhebcr_Ra_Se_Qr_Rf_Vg_Qvfp_8_Znahnyf_Qvfp_Ereryrnfr_7z_Scan_{Guid.NewGuid():N}";
            ...
            ////////////////////////////////////////
            Assert.NotNull(r);
            Assert.Equal("Abk (Rhebcr) (Ra,Se,Qr,Rf,Vg) (Qvfp 8) (Znahnyf Qvfp) (Ereryrnfr).nkit.yaml", r.FinalName);
            Assert.Null(r.ChkCompared);
            Assert.Null(r.InFileParts);
            Assert.NotNull(r.OutFileParts);
            Assert.Equal(1, r.OutFileParts.Length);
            Assert.Equal(0x6b20b00L, r.OutFileParts[0].Size);
            ...
            Assert.Equal("Abk (Rhebcr) (Ra,Se,Qr,Rf,Vg) (Qvfp 8) (Znahnyf Qvfp) (Ereryrnfr)", r.OutFileParts[0].FileName);
            ...
            Assert.Equal(0x6b20b00L, t.StepFiles[0].Size);
            ...
            Assert.Equal("Abk (Rhebcr) (Ra,Se,Qr,Rf,Vg) (Qvfp 8) (Znahnyf Qvfp) (Ereryrnfr)", t.StepFiles[0].FileName);
