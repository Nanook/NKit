...
public class ScanSettingsViewModel : TaskSettingsViewModelBase
{
    public ScanSettingsViewModel() : base(Locator.Current.GetService<NKitSettings>())
    {
    ...
    {
        if (Settings.Task == TaskType.Scan)
