...
public class FixSettingsViewModel : TaskSettingsViewModelBase
{
    public FixSettingsViewModel() : base(Locator.Current.GetService<NKitSettings>())
    {
