...
namespace CUETools.Codecs.Flake
{
    internal class FlakeConstants
    {
        ...
        public static PredictionType LookupPredictionType(string name) => (PredictionType)Enum.Parse(typeof(PredictionType), name, true);

        public static StereoMethod LookupStereoMethod(string name) => (StereoMethod)Enum.Parse(typeof(StereoMethod), name, true);

        public static WindowMethod LookupWindowMethod(string name) => (WindowMethod)Enum.Parse(typeof(WindowMethod), name, true);

        public static OrderMethod LookupOrderMethod(string name) => (OrderMethod)Enum.Parse(typeof(OrderMethod), name, true);

        public static WindowFunction LookupWindowFunction(string name) => (WindowFunction)Enum.Parse(typeof(WindowFunction), name, true);
    }
}
