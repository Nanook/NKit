namespace CUETools.Codecs.Flake
{
    unsafe public class FlacFrame
    {
        ...
        internal int bs_code0, bs_code1;
        internal ChannelMode ch_mode;
        //public int ch_order0, ch_order1;
        internal byte crc8;
        internal FlacSubframeInfo[] subframes;
        internal int frame_number;
        internal FlacSubframe current;
        internal float* window_buffer;
        internal int nSeg = 0;

        internal BitWriter writer = null;
        internal int writer_offset = 0;
