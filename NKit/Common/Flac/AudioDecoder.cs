...
namespace CUETools.Codecs.Flake
{
    internal class AudioDecoder : IAudioSource
    {
        ...
        public AudioDecoder(DecoderSettings settings, string path, Stream IO = null)
        {
            ...
            else if (samplesBuffer.Length != FlakeConstants.MAX_BLOCKSIZE * PCM.ChannelCount)
                samplesBuffer = new int[FlakeConstants.MAX_BLOCKSIZE * PCM.ChannelCount];
            if (residualBuffer == null)
                residualBuffer = new int[FlakeConstants.MAX_BLOCKSIZE * PCM.ChannelCount];
            else if (residualBuffer.Length != FlakeConstants.MAX_BLOCKSIZE * PCM.ChannelCount)
                residualBuffer = new int[FlakeConstants.MAX_BLOCKSIZE * PCM.ChannelCount];
        }
