...
namespace CUETools.Codecs.Flake
{
    ...
    internal static class IAudioDecoderSettingsExtensions
    {
        public static bool HasBrowsableAttributes(this IAudioDecoderSettings settings)
        {
            ...
            foreach (PropertyDescriptor property in TypeDescriptor.GetProperties(settings))
            {
                ...
                foreach (object attribute in property.Attributes)
                {
        ...
        public static IAudioSource Open(this IAudioDecoderSettings settings, string path, Stream IO = null) => Activator.CreateInstance(settings.DecoderType, settings, path, IO) as IAudioSource;
    }
}
